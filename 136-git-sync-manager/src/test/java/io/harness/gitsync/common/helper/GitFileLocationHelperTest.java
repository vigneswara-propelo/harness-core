...
public class GitFileLocationHelperTest extends CategoryTest {
  ...
  final String filePath = rootPath + PATH_DELIMITER + entityType.getEntityDisplayName() + PATH_DELIMITER
  ...
  public void getEntityPath() {
    final String entityPath =
        GitFileLocationHelper.getEntityPath(rootPath, entityType.getEntityDisplayName(), entityIdentifier);
