...
public class GitlabListFilesScmApiErrorHandlerTest extends GitSyncTestBase {
  @Inject GitlabListFilesScmApiErrorHandler gitlabListFilesScmApiErrorHandler;
  ...
  public void testHandleErrorOnUnauthorizedResponse() {
    try {
      gitlabListFilesScmApiErrorHandler.handleError(401, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorOnResourceNotFoundResponse() {
    try {
      gitlabListFilesScmApiErrorHandler.handleError(404, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorWhenUnexpectedStatusCode() {
    try {
      gitlabListFilesScmApiErrorHandler.handleError(405, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
