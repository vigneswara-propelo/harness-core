...
public class GitlabCreatePullRequestScmApiErrorHandlerTest extends GitSyncTestBase {
  @Inject GitlabCreatePullRequestScmApiErrorHandler gitlabCreatePullRequestScmApiErrorHandler;
  ...
  public void testHandleErrorOnUnauthorizedResponse() {
    try {
      gitlabCreatePullRequestScmApiErrorHandler.handleError(401, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorOnResourceNotFoundResponse() {
    try {
      gitlabCreatePullRequestScmApiErrorHandler.handleError(404, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorOnUnprocessableEntityResponse() {
    try {
      gitlabCreatePullRequestScmApiErrorHandler.handleError(409, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
      WingsException exception = ExceptionUtils.cause(ScmBadRequestException.class, ex);
      assertThat(exception).isNotNull();
  ...
  public void testHandleErrorWhenUnexpectedStatusCode() {
    try {
      gitlabCreatePullRequestScmApiErrorHandler.handleError(405, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
