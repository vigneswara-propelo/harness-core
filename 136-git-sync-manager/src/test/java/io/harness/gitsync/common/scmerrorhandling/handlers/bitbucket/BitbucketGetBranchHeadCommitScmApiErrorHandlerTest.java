...
public class BitbucketGetBranchHeadCommitScmApiErrorHandlerTest extends GitSyncTestBase {
  @Inject BitbucketGetBranchHeadCommitScmApiErrorHandler bitbucketGetBranchHeadCommitScmApiErrorHandler;
  ...
  public void testHandleErrorOnUnauthenticatedResponse() {
    try {
      bitbucketGetBranchHeadCommitScmApiErrorHandler.handleError(403, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorOnWrongBranchOrRepoResponse() {
    try {
      bitbucketGetBranchHeadCommitScmApiErrorHandler.handleError(404, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
