...
public class GitlabGetFileScmApiErrorHandlerTest extends GitSyncTestBase {
  @Inject GitlabGetFileScmApiErrorHandler gitlabGetFileScmApiErrorHandler;
  ...
  public void testHandleErrorOnUnauthorizedResponse() {
    try {
      gitlabGetFileScmApiErrorHandler.handleError(401, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorOnResourceNotFoundResponse() {
    try {
      gitlabGetFileScmApiErrorHandler.handleError(404, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
  ...
  public void testHandleErrorWhenUnexpectedStatusCode() {
    try {
      gitlabGetFileScmApiErrorHandler.handleError(405, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
