...
@Slf4j
@OwnedBy(PIPELINE)
public class GitlabListBranchesScmApiErrorHandler implements ScmApiErrorHandler {
  public static final String LIST_BRANCH_FAILED_MESSAGE = "Listing branches from Gitlab failed. ";
    ...
    switch (statusCode) {
      case 401:
        throw NestedExceptionUtils.hintWithExplanationException(
            ...
            ErrorMessageFormatter.formatMessage(LIST_BRANCH_FAILED_MESSAGE + INVALID_CONNECTOR_CREDS, errorMetadata),
      ...
      default:
        log.error(String.format("Error while listing gitlab branches: [%s: %s]", statusCode, errorMessage));
