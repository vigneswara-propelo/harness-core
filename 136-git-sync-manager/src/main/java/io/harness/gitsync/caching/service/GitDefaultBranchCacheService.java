...
public interface GitDefaultBranchCacheService {
  GitDefaultBranchCacheResponse fetchFromCache(GitDefaultBranchCacheKey gitDefaultBranchCacheKey);

  GitDefaultBranchCacheResponse upsertCache(GitDefaultBranchCacheKey gitDefaultBranchCacheKey, String branch);

  GitDefaultBranchDeleteResponse invalidateCache(
      GitDefaultBranchCacheKeyFilterParams gitDefaultBranchCacheKeyFilterParams);

  List<GitDefaultBranchCacheResponse> listFromCache(
      GitDefaultBranchCacheKeyFilterParams gitDefaultBranchCacheKeyFilterParams);
}
