...
public class TimeBucket14 extends AbstractRoutine<OffsetDateTime> {
   ...
   */
  public TimeBucket14 setBucketWidth(Field<YearToSecond> field) {
   ...
   */
  public TimeBucket14 setTs(Field<OffsetDateTime> field) {
    setField(TS, field);
    return this;
  }
   ...
   */
  public TimeBucket14 setOffset(Field<YearToSecond> field) {
