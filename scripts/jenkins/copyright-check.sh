...
EXCLUSION_LIST='\.remote\|\.pem\|\.tgz\|\.zip\|\.tar\|\.tar.gz\|\.tpl\|\.lock\|\.helmignore\|\.mod\|\.sum\|\.log\|\.toml\|\.yml\|\.yaml\|\.properties\|\.md\|\.json\|\.config\|\.env\|\.txt\|\.info\|\.jks\|\.mod\|\.env\|\.xml\|\.jfc\|\.MD\|\.factories\|exclusion-file\|project/bazelproject\|scripts/jenkins/bazelignore\|scripts/jenkins/sonarIgnore\|resources/mockito-extensions\|\.bazelignore\|\.datacollection\|\.tf\|\.ftl\|\.gitignore\|^\.'
