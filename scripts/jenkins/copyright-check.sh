...
EXCLUSION_LIST='\.pem\|\.tgz\|\.tpl\|\.mod\|\.sum\|\.log\|\.toml\|\.yml\|\.yaml\|\.properties\|\.md\|\.json\|\.config\|\.env\|\.txt\|\.info\|\.jks\|\.mod\|\.env\|\.xml\|\.jfc\|\.MD\|\.factories\|project/bazelproject\|scripts/jenkins/bazelignore\|resources/mockito-extensions\|\.bazelignore\|\.datacollection\|\.tf\|\.ftl\|\.gitignore\|^\.'
