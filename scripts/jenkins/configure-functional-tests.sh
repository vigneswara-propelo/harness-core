...
replace_text "sentinel: false" "sentinel: true" 315-sto-manager/config/sto-manager-config.yml
replace_text "enterpriseCacheEnabled: true" "enterpriseCacheEnabled: false" 315-sto-manager/config/sto-manager-config.yml
replace_text "cacheBackend: REDIS" "cacheBackend: HAZELCAST" 315-sto-manager/config/sto-manager-config.yml
replace_text "masterName: \"test\"" "masterName: \"${REDIS_MASTER_NAME}\"" 360-cg-manager/config.yml
replace_text "masterName: \"test\"" "masterName: \"${REDIS_MASTER_NAME}\"" 315-sto-manager/config/sto-manager-config.yml
...
replace_text "\"redis://redis1:26379\"" "\"${REDIS_SENTINEL1}\"" 315-sto-manager/config/sto-manager-config.yml
replace_text "\"redis://redis2:26379\"" "\"${REDIS_SENTINEL2}\"" 315-sto-manager/config/sto-manager-config.yml
replace_text "\"redis://redis3:26379\"" "\"${REDIS_SENTINEL3}\"" 315-sto-manager/config/to-manager-config.yml
...
replace_text "uri: mongodb://localhost:27017/sto-harness" "uri: ${MONGO_URI}_sto" 315-sto-manager/config/sto-manager-config.yml
replace_text "uri: mongodb://localhost:27017/harness" "uri: ${MONGO_URI}" 332-ci-manager/config/ci-manager-config.yml

CONFIG_FILES=(360-cg-manager/config.yml 350-event-server/event-service-config.yml 210-command-library-server/command-library-server-config.yml 332-ci-manager/config/ci-manager-config.yml 315-sto-manager/config/sto-manager-config.yml)
