...
docker build -t us.gcr.io/platform-205701/harness/${SNAPSHOT_PREFIX}manager:${VERSION} destination/dist/manager -f destination/dist/manager/Dockerfile-gcr
docker push us.gcr.io/platform-205701/harness/${SNAPSHOT_PREFIX}manager:${VERSION}
