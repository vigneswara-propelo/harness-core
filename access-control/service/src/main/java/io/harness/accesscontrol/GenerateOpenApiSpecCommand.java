...
@Slf4j
public class GenerateOpenApiSpecCommand extends ConfiguredCommand<AccessControlConfiguration> {
  ...
  @Override
  protected void run(Bootstrap<AccessControlConfiguration> bootstrap, Namespace namespace,
      AccessControlConfiguration configuration) throws Exception {
