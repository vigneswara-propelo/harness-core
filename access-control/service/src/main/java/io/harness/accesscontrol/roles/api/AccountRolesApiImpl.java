...
public class AccountRolesApiImpl implements AccountRolesApi {
  ...
  public Response createRoleAcc(CreateRoleRequest body, @AccountIdentifier String account) {
    ...
    RoleDTO roleDTO = RoleApiUtils.getRoleAccDTO(body);
  ...
  @Override
  public Response listRolesAcc(String account, Integer page, Integer limit, String searchTerm) {
    accessControlClient.checkForAccessOrThrow(
    ...
    ResponseBuilder responseBuilderWithLinks =
        RoleApiUtils.addLinksHeader(responseBuilder, "/v1/roles", pageResponse.getContent().size(), page, limit);
  ...
  public Response updateRoleAcc(CreateRoleRequest body, String role, String account) {
    ...
    RolesResponse response = Failsafe.with(transactionRetryPolicy).get(() -> transactionTemplate.execute(status -> {
      RoleUpdateResult roleUpdateResult =
          roleService.update(fromDTO(scopeIdentifier, RoleApiUtils.getRoleAccDTO(body)));
