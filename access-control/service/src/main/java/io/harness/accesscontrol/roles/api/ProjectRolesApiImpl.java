...
public class ProjectRolesApiImpl implements ProjectRolesApi {
  ...
  public Response createRoleProject(
    ...
    RoleDTO roleDTO = RoleApiUtils.getRoleProjectDTO(body);
  ...
  @Override
  public Response listRolesProject(
      String org, String project, String account, Integer page, Integer limit, String searchTerm) {
    accessControlClient.checkForAccessOrThrow(
    ...
    ResponseBuilder responseBuilderWithLinks = RoleApiUtils.addLinksHeader(responseBuilder,
  ...
  public Response updateRoleProject(CreateRoleRequest body, String org, String project, String role, String account) {
    ...
    RolesResponse response = Failsafe.with(transactionRetryPolicy).get(() -> transactionTemplate.execute(status -> {
      RoleUpdateResult roleUpdateResult =
          roleService.update(fromDTO(scopeIdentifier, RoleApiUtils.getRoleProjectDTO(body)));
