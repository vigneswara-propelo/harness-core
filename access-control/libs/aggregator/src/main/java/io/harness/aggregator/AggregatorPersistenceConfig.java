...
@EnableMongoRepositories(
    basePackages = {"io.harness.aggregator.repositories"}, includeFilters = @ComponentScan.Filter(HarnessRepo.class))
public class AggregatorPersistenceConfig extends AbstractMongoClientConfiguration {
  private final MongoConfig mongoBackendConfiguration;

  @Inject
  public AggregatorPersistenceConfig(Injector injector) {
