...
package io.harness.debezium.redisconsumer;
...
@Slf4j
public class DebeziumAbstractRedisConsumer extends RedisTraceConsumer implements PmsRedisConsumer {
  ...
  public DebeziumAbstractRedisConsumer(Consumer redisConsumer, QueueController queueController,
