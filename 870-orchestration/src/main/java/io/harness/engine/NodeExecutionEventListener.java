...
import io.harness.pms.sdk.core.execution.ResumeNodeExecutionEventData;
import io.harness.pms.sdk.core.execution.StartNodeExecutionEventData;
  ...
  private void startExecution(NodeExecutionEvent event) {
    try {
      ...
      processor.handleStart(InvokerPackage.builder()
                                ...
                                .passThroughData(eventData.getFacilitatorResponse().getPassThroughData())
