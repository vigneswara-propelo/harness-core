...
package io.harness.overviewdashboard;

import static javax.ws.rs.core.MediaType.APPLICATION_JSON_TYPE;
import static org.apache.commons.lang3.StringUtils.EMPTY;

import io.harness.DashboardServiceConfig;
...
@Slf4j
public class GenerateOpenApiSpecCommand extends ConfiguredCommand<DashboardServiceConfig> {
  ...
  @Override
  protected void run(Bootstrap<DashboardServiceConfig> bootstrap, Namespace namespace,
      DashboardServiceConfig configuration) throws Exception {
