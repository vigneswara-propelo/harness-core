...
def test_default_tokenizer():
    ...
    tokens = Tokenizer.default_tokenizer(str)
    expected_tokens = ['info', 'org.quartz.plugins.history.loggingtriggerhistoryplugin', 'trigger',
                       'default.vj3t7b6htyyugnj0jifqxa', 'completed', 'firing', 'with', 'resulting', 'trigger',
                       'instruction', 'code', 'nothing']
