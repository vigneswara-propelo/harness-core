...
public class MarkSuccessAdviseHandlerTest extends OrchestrationTestBase {
  @Mock private InterruptManager interruptManager;
  @Inject @InjectMocks private MarkSuccessAdviseHandler handler;
  ...
  public void handleAdvise() {
    ...
    assertThat(interruptPackage.getInterruptType()).isEqualTo(InterruptType.MARK_SUCCESS);
