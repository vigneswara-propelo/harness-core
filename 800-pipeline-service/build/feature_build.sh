...
chmod +x 800-pipeline-service/build/build_jar.sh
chmod +x 800-pipeline-service/build/build_dist.sh

800-pipeline-service/build/build_jar.sh
800-pipeline-service/build/build_dist.sh || true
