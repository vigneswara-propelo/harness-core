...
public class AppdVerifyStep implements SyncExecutable<MapStepParameters> {
  public static final StepType STEP_TYPE = StepType.newBuilder().setType("appdVerify").build();
  ...
  public StepResponse executeSync(Ambiance ambiance, MapStepParameters stepParameters, StepInputPackage inputPackage,
    ...
    log.info("Appd Verify Step parameters: {}", RecastOrchestrationUtils.toDocumentJson(stepParameters));
