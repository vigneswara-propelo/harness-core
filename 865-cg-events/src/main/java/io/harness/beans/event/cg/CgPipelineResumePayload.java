...
@Data
@OwnedBy(CDC)
public class CgPipelineResumePayload extends CgPipelineExecutionPayload {
  public CgPipelineResumePayload() {}

  private List<PipelineStageInfo> stages;

  @Builder
  public CgPipelineResumePayload(ApplicationEventData application, PipelineEventData pipeline,
