...
public class HACLRepositoryCustomImpl implements ACLRepositoryCustom {
  ...
  private static final String PRINCIPAL_TYPE_KEY =
      HACLKeys.principal + "." + HUserPrincipal.PrincipalKeys.principalType;
  private static final String PRINCIPAL_IDENTIFIER_KEY =
      HACLKeys.principal + "." + HUserPrincipal.PrincipalKeys.principalIdentifier;
