...
public class V1ReplicaSetHandlerTest extends CategoryTest {
  ...
  private final ClusterDetails clusterDetails = ClusterDetails.builder()
                                                    ...
                                                    .build();
  private V1ReplicaSetHandler replicaSetHandler;
  private ArgumentCaptor<Message> captor;

  @Before
  public void setUp() throws Exception {
    eventPublisher = mock(EventPublisher.class);
    replicaSetHandler = new V1ReplicaSetHandler(eventPublisher, clusterDetails);
  ...
  public void shouldPublishWorkloadSpecOnAdd() throws Exception {
    V1ReplicaSet replicaSet = new V1ReplicaSetBuilder()
                                  ...
                                  .endSpec()
                                  .build();
    replicaSetHandler.onAdd(replicaSet);
  ...
  public void shouldPublishWorkloadSpecOnUpdateIfChangeMade() throws Exception {
    V1ReplicaSet oldReplicaSet = new V1ReplicaSetBuilder()
                                     .withNewMetadata()
                                     .withName("test-name")
                                     .withNamespace("test-namespace")
                                     .endMetadata()
                                     ...
                                     .endSpec()
                                     .build();
    V1ReplicaSet newReplicaSet = new V1ReplicaSetBuilder(oldReplicaSet)
                                     .withNewSpec()
                                     .withNewTemplate()
                                     .withNewSpec()
                                     .addNewInitContainer()
                                     ...
                                     .endSpec()
                                     .build();
    replicaSetHandler.onUpdate(oldReplicaSet, newReplicaSet);
