...
import software.wings.core.ssh.executors.SshUserInfo;
...
public class ScpTo {
  public static void main(String[] arg) {
    ...
    try {
      String lfile = "/Users/peeyushaggarwal/test1.txt";
      String user = "peeyushaggarwal";
      ...
      session.setUserInfo(new SshUserInfo("fedk2ZTB$#"));
      session.connect();
