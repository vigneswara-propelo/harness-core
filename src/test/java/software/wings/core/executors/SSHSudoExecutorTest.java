...
//        SSHSudoCommandExecutor executor =
//                new SSHSudoCommandExecutor("localhost", 2222, "osboxes", "osboxes.org", "sudo su - vagrant  -c 'ls &&
//                whoami'", new ConsoleExecutionCallback(null));
//        executor.execute();
//    }
//}