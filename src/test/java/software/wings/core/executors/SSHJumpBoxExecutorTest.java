...
//        SSHJumpBoxCommandExecutor executor = new SSHJumpBoxCommandExecutor("192.168.1.14", 22, "osboxes",
//        "osboxes.org", "ls && whoami", new ConsoleExecutionCallback(null)); executor.execute();
//    }
//}