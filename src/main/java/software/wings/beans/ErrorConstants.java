...
public interface ErrorConstants {
  ...
  public static final String INVALID_CREDENTIAL = "INVALID_CREDENTIAL_ERROR_MSG";
  public static final String INVALID_KEY = "INVALID_KEY_ERROR_MSG";
  public static final String INVALID_KEYPATH = "INVALID_KEYPATH_ERROR_MSG";
  public static final String UNKNOWN_HOST = "UNKNOWN_HOST_ERROR_MSG";
  public static final String COMMAND_EXEC_TIMEOUT = "COMMAND_EXEC_TIMEOUT_MSG";
  public static final String SSH_SESSION_TIMEOUT = "SSH_SESSION_TIMEOUT_MSG";
  public static final String SSH_SOCKET_CONNECTION = "SSH_SOCKET_CONNECTION_ERROR_MSG";
  public static final String UNKNOWN_ERROR = "UNKNOWN_ERROR_MSG";
