...
import io.harness.cf.openapi.auth.ApiKeyAuth;
import io.harness.cf.openapi.auth.Authentication;
import io.harness.cf.openapi.auth.HttpBasicAuth;
import io.harness.cf.openapi.auth.HttpBearerAuth;
...
public class ApiClient {
   ...
   * Set base path
   *
   * @param basePath Base path of the URL (e.g http://localhost/api/1.0
  ...
  public void updateParamsForAuth(
      String[] authNames, List<Pair> queryParams, Map<String, String> headerParams, Map<String, String> cookieParams) {
  ...
  private void applySslSettings() {
    try {
      ...
      if (!verifyingSsl) {
        trustManagers = new TrustManager[] {new X509TrustManager(){@Override public void checkClientTrusted(
