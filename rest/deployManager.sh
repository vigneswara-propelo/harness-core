...
export HOSTNAME
NEW_RELIC_APP_NAME="${2}" nohup java -Xms1024m -Xmx4096m -XX:-HeapDumpOnOutOfMemoryError -Dfile.encoding=UTF-8 -jar $HOME/rest-0.0.1-SNAPSHOT-capsule.jar config.yml > portal.log 2>&1 &
