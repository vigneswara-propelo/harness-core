...
public class PreferenceServiceTest extends WingsBaseTest {
  ...
  public void shouldGet() {
    ...
    assertThat(preferenceService.get(TEST_ACCOUNT_ID, TEST_USER_ID, savedPreference.getUuid()))
        .isEqualTo(savedPreference);
  }

  @Test
  public void shouldCreate() {
    Preference createdPreference = preferenceService.save(TEST_ACCOUNT_ID, TEST_USER_ID, preference);
  ...
  public void shouldUpdate() {
    ...
    preferenceService.update(TEST_ACCOUNT_ID, TEST_USER_ID, savedPreference.getUuid(), savedPreference);
  ...
  public void shouldDelete() {
    ...
    preferenceService.delete(TEST_ACCOUNT_ID, TEST_USER_ID, TEST_PREFERENCE_ID);
