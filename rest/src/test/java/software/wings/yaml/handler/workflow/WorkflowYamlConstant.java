...
public class WorkflowYamlConstant {
  // START STRING CONSTANTS FOR BASIC WORFLOW YAML TEST
  ...
  // END STRING CONSTANTS FOR BASIC WORFLOW YAML TEST

  // START STRING CONSTANTS FOR BUILD WORFLOW YAML TEST
  ...
  public static final String BUILD_INVALID_YAML_CONTENT = "envName: env1\nphaseInvalid: phase1\ntype: BUILD";
