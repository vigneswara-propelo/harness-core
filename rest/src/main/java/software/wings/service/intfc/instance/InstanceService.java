...
public interface InstanceService {
  ...
  /**
   * Builds the instances from the phase execution data
   * @param workflowExecution
   * @param artifact
   * @param instanceStatusSummary
   * @param phaseExecutionData
   * @param infraMappingType
   * @return
   */
  Instance buildInstance(WorkflowExecution workflowExecution, Artifact artifact,
  ...
  /**
   *
   * @param stateExecutionData
   * @param workflowStandardParams
   * @param appId
   * @param workflowExecution
   */
  void extractInstanceOrContainerInfoBaseOnType(StateExecutionData stateExecutionData,
