...
public class AwsEc2ServiceImpl implements AwsEc2Service {
  ...
  @Override
  public List<Instance> describeEc2Instances(AwsConfig awsConfig, List<EncryptedDataDetail> encryptionDetails,
      String region, DescribeInstancesRequest describeInstancesRequest) {
    return getInstanceList(
        awsHelperService.describeEc2Instances(awsConfig, encryptionDetails, region, describeInstancesRequest));
  }
