...
public class WorkflowExecutionBaselineServiceImpl implements WorkflowExecutionBaselineService {
  ...
  @Override
  public void markBaseline(List<WorkflowExecutionBaseline> workflowExecutionBaselines, String executionId) {
    ...
    for (WorkflowExecutionBaseline workflowExecutionBaseline : workflowExecutionBaselines) {
      ...
      markPipelineWorkflowBaselineIfNecessary(workflowExecutionBaseline, true);
    }
