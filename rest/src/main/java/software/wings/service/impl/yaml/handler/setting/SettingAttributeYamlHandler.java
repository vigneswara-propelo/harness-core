 ...
 */
public abstract class SettingAttributeYamlHandler<Y extends SettingValue.Yaml, B extends SettingValue>
    extends BaseYamlHandler<Y, SettingAttribute> {
  private static final Logger logger = LoggerFactory.getLogger(SettingAttributeYamlHandler.class);
