...
public class AuthHandlerImpl implements AuthHandler {
  private static final Logger logger = LoggerFactory.getLogger(AuthHandlerImpl.class);

  private PipelineService pipelineService;
  private AppService appService;
  private ServiceResourceService serviceResourceService;
  private InfrastructureProvisionerService infrastructureProvisionerService;
  ...
  @Inject
  public AuthHandlerImpl(PipelineService pipelineService, AppService appService,
      ServiceResourceService serviceResourceService, InfrastructureProvisionerService infrastructureProvisionerService,
      EnvironmentService environmentService, WorkflowService workflowService, UserGroupService userGroupService,
      AuthService authService) {
    this.pipelineService = pipelineService;
    this.appService = appService;
    this.serviceResourceService = serviceResourceService;
    this.infrastructureProvisionerService = infrastructureProvisionerService;
