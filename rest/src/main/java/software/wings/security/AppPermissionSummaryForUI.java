...
public class AppPermissionSummaryForUI {
  ...
  @Builder
  public AppPermissionSummaryForUI(boolean canCreateService, boolean canCreateEnvironment, boolean canCreateWorkflow,
      boolean canCreatePipeline, Map<String, Set<Action>> servicePermissions, Map<String, Set<Action>> envPermissions,
