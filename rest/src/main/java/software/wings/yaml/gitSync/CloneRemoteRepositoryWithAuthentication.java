...
public class CloneRemoteRepositoryWithAuthentication {
  ...
  public static void main(String[] args) throws IOException, GitAPIException {
    // this is necessary when the remote host does not have a valid certificate, ideally we would install the
    // certificate in the JVM instead of this unsecure workaround!
