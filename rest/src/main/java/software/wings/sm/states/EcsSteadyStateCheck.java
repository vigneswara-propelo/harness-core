...
public class EcsSteadyStateCheck extends State {
  ...
  @Attributes(title = "Ecs Cluster") @Getter @Setter private String ecsClusterName;
  @Attributes(title = "Ecs Service") @Getter @Setter private String ecsServiceName;
  @Attributes(title = "Region") @DefaultValue("us-east-1") @Getter @Setter private String region;
    ...
    try {
      ...
      DelegateTask delegateTask =
          aDelegateTask()
              ...
              .withTaskType(TaskType.ESC_STEADY_STATE_CHECK_TASK)
