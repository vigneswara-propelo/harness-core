...
public class EcsServiceSetup extends ContainerServiceSetup {
  ...
  protected ContainerSetupParams buildContainerSetupParams(ExecutionContext context, String serviceName,
    ...
    return anEcsSetupParams()
        ...
        .withLoadBalancerName(context.renderExpression(loadBalancerName))
        .withInfraMappingId(infrastructureMapping.getUuid())
        .withRoleArn(context.renderExpression(roleArn))
        .withTargetGroupArn(context.renderExpression(targetGroupArn))
        ...
        .withTargetContainerName(context.renderExpression(targetContainerName))
        .withTargetPort(context.renderExpression(targetPort))
