 ...
 */
public class TimeMetric<T extends Number> extends Metric<T> {
  ...
  public TimeMetric(String name, String path, MetricType type, double threshold, boolean alertWhenMoreThan) {
