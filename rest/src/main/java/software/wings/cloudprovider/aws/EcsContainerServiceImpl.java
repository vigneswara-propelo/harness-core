    ...
    CreateStackResult result = amazonCloudFormationClient.createStack(
        new CreateStackRequest()
            ...
            .withTemplateBody("AWSTemplateFormatVersion: '2010-09-09'\n"
                + "Description: >\n"
                + "  AWS CloudFormation template to createStateMachine a new VPC\n"
                ...
                + "      your container instances. If you specify a VPC ID, you must specify a listStateMachines of\n"
                ...
                + "    Description: >\n"
                + "      Optional - Specifies the Comma separated listStateMachines of existing VPC Subnet\n"
                ...
                + "    Type: CommaDelimitedList\n"
                + "    Description: >\n"
                + "      Specifies a comma-separated listStateMachines of 3 VPC Availability Zones for\n"
