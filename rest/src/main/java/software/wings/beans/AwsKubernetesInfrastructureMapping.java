...
public class AwsKubernetesInfrastructureMapping extends InfrastructureMapping {
  ...
  public static final class Builder {
     ...
     * @return the builder
     */
    public static Builder anAwsKubernetesInfrastructureMapping() {
      return new Builder();
    }
     ...
     */
    public Builder but() {
      return anAwsKubernetesInfrastructureMapping()
     ...
     */
    public AwsKubernetesInfrastructureMapping build() {
      AwsKubernetesInfrastructureMapping awsKubernetesInfrastructureMapping = new AwsKubernetesInfrastructureMapping();
      awsKubernetesInfrastructureMapping.setClusterName(clusterName);
      awsKubernetesInfrastructureMapping.setComputeProviderSettingId(computeProviderSettingId);
      awsKubernetesInfrastructureMapping.setEnvId(envId);
      awsKubernetesInfrastructureMapping.setServiceTemplateId(serviceTemplateId);
      ...
      awsKubernetesInfrastructureMapping.setDisplayName(displayName);
      awsKubernetesInfrastructureMapping.setUuid(uuid);
      awsKubernetesInfrastructureMapping.setAppId(appId);
      awsKubernetesInfrastructureMapping.setCreatedBy(createdBy);
      awsKubernetesInfrastructureMapping.setCreatedAt(createdAt);
      awsKubernetesInfrastructureMapping.setLastUpdatedBy(lastUpdatedBy);
      awsKubernetesInfrastructureMapping.setLastUpdatedAt(lastUpdatedAt);
      return awsKubernetesInfrastructureMapping;
    }
  }
}
