...
public class WorkflowFailureStrategy extends Base {
  ...
  public boolean equals(Object o) {
    ...
    WorkflowFailureStrategy that = (WorkflowFailureStrategy) o;

    if (name != null ? !name.equals(that.name) : that.name != null)
      return false;
    if (workflowExecutionFilter != null ? !workflowExecutionFilter.equals(that.workflowExecutionFilter)
                                        : that.workflowExecutionFilter != null)
      return false;
    return failureStrategyList != null ? failureStrategyList.equals(that.failureStrategyList)
                                       : that.failureStrategyList == null;
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (workflowExecutionFilter != null ? workflowExecutionFilter.hashCode() : 0);
    result = 31 * result + (failureStrategyList != null ? failureStrategyList.hashCode() : 0);
    return result;
  }
