...
public enum TaskType {
  ...
  NEXUS_GET_ARTIFACT_NAMES(TaskGroup.NEXUS, ServiceImplDelegateTask.class, NexusValidation.class),
  ...
  AMAZON_S3_GET_ARTIFACT_NAMES(TaskGroup.S3, ServiceImplDelegateTask.class, AlwaysTrueValidation.class),
  AMAZON_S3_GET_PLANS(TaskGroup.S3, ServiceImplDelegateTask.class, AlwaysTrueValidation.class),
  AMAZON_S3_VALIDATE_ARTIFACT_SERVER(TaskGroup.S3, ServiceImplDelegateTask.class, AlwaysTrueValidation.class),
  ...
  ARTIFACTORY_GET_ARTIFACT_NAMES(TaskGroup.ARTIFACTORY, ServiceImplDelegateTask.class, ArtifactoryValidation.class),
