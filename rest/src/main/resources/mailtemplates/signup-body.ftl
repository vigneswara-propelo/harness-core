        ...
        <table style="border-spacing: 0; border: none; border-width: 0; width: 100%; max-width: 550px;">
          ...
          <tr style="background-color: #fff; height: 280px;">
            <td align="center" style="line-height: 35px; vertical-align: middle; height: 150px; font-size: 24px; color: #77787b; font-family: 'Source Sans Pro', Arial, Helvetica, sans-serif;">
              Hi ${(name!"there")?capitalize},<br/>Welcome to Harness!<br/><br/>

              <a href="${url!}" style="height: 44px; font-size: 16px; font-family: 'Source Sans Pro', Arial, Helvetica, sans-serif; margin: auto; padding: 15px 20px; text-decoration: none; border-radius: 2px; text-align: center; vertical-align: middle; font-weight: bold; background-color: #000; color: #fff;">ACTIVATE YOUR HARNESS ACCOUNT</a>
            </td>
          </tr>
