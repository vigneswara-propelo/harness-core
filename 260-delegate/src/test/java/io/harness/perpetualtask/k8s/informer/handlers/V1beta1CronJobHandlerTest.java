...
public class V1beta1CronJobHandlerTest extends CategoryTest {
  ...
  public void shouldPublishWorkloadSpecOnAdd() throws Exception {
    V1beta1CronJob cronjob = new V1beta1CronJobBuilder()
                                 .withNewMetadata()
                                 .withName("test-name")
  ...
  public void shouldPublishWorkloadSpecOnUpdateIfChangeMade() throws Exception {
    V1beta1CronJob oldCronJob = new V1beta1CronJobBuilder()
                                    .withNewMetadata()
                                    .withName("test-name")
                                    .withNamespace("test-namespace")
                                    .withUid("test-uid")
                                    ...
                                    .endSpec()
                                    .build();
    V1beta1CronJob newCronJob = new V1beta1CronJobBuilder(oldCronJob)
                                    .withNewSpec()
                                    .withNewJobTemplate()
                                    .withNewSpec()
                                    .withNewTemplate()
