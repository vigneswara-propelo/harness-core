...
chmod +x audit-event-streaming/build/build_jar.sh
chmod +x audit-event-streaming/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD audit-event-streaming/build.properties
audit-event-streaming/build/build_jar.sh
audit-event-streaming/build/build_dist.sh || true
