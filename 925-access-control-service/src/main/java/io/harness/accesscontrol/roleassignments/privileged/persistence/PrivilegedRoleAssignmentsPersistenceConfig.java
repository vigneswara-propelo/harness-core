...
@Configuration
@EnableMongoRepositories(basePackages = {"io.harness.accesscontrol.roleassignments.privileged.persistence"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class))
@OwnedBy(HarnessTeam.PL)
public class PrivilegedRoleAssignmentsPersistenceConfig extends AbstractMongoConfiguration {
  private final MongoConfig mongoBackendConfiguration;

  @Inject
  public PrivilegedRoleAssignmentsPersistenceConfig(Injector injector) {
