...
import io.harness.hsqs.client.auth.ApiKeyAuth;
import io.harness.hsqs.client.auth.Authentication;
import io.harness.hsqs.client.auth.HttpBasicAuth;
import io.harness.hsqs.client.auth.OAuth;
...
public class ApiClient {
  ...
  public List<Pair> parameterToPair(String name, Object value) {
    ...
    // preconditions
    if (isEmpty(name) || value == null || value instanceof Collection) {
      return params;
    }
  ...
  public String buildUrl(String path, List<Pair> queryParams, List<Pair> collectionQueryParams) {
    ...
    if (isEmpty(collectionQueryParams)) {
    ...
    for (Entry<String, Object> param : formParams.entrySet()) {
      if (param.getValue() instanceof File) {
        ...
        Headers partHeaders = Headers.of(
            "Content-Disposition", "form-data; name=\"" + param.getKey() + "\"; filename=\"" + file.getName() + "\"");
