...
@OwnedBy(PIPELINE)
public class PlanCreationResponseTest extends CategoryTest {
  @Test
  @Owner(developers = NAMAN)
  @Category(UnitTests.class)
  public void testMergePreservedNodesInRollbackMode() {
    PlanCreationResponse nullList = PlanCreationResponse.builder().build();
    ...
    PlanCreationResponse withPreservedNodes =
        PlanCreationResponse.builder().preservedNodesInRollbackMode(Collections.singletonList("n1")).build();
