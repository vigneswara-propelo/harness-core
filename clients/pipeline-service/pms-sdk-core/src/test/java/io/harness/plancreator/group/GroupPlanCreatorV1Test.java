...
public class GroupPlanCreatorV1Test extends CategoryTest {
  @Mock KryoSerializer kryoSerializer;
  @InjectMocks GroupPlanCreatorV1 planCreator;
  YamlField pipelineYamlField;
  @Before
  public void setUp() throws IOException {
    MockitoAnnotations.initMocks(this);
    ClassLoader classLoader = this.getClass().getClassLoader();
    final URL testFile = classLoader.getResource("complex-pipeline-with-group-v1.yaml");
  ...
  public void testGetSupportedTypes() {
    assertThat(planCreator.getSupportedTypes())
        .isEqualTo(Collections.singletonMap("group", Collections.singleton(PlanCreatorUtils.ANY_TYPE)));
  }
