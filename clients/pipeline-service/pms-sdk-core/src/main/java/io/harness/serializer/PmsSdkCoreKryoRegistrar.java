...
public class PmsSdkCoreKryoRegistrar implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(IgnoreFailureActionConfigV1.class, 878039);
    kryo.register(AbortFailureActionConfigV1.class, 878040);
    kryo.register(RetryFailureActionConfigV1.class, 878041);
    kryo.register(ManualInterventionFailureActionConfigV1.class, 878042);
    kryo.register(RetrySGFailureActionConfigV1.class, 878043);
    kryo.register(MarkAsSuccessFailureActionConfigV1.class, 878044);
    kryo.register(MarkAsFailFailureActionConfigV1.class, 878045);
    kryo.register(StageRollbackFailureActionConfigV1.class, 878046);
    kryo.register(PipelineRollbackFailureActionConfigV1.class, 878047);
    ...
    kryo.register(FailureConfigV1.class, 878054);
  }
}
