...
package io.harness.pms.sdk.metrics;
...
@Slf4j
public class PmsSdkThreadMetricsPublisher implements MetricsPublisher {
  ...
  private static final Set<String> metricFilters = Set.of("PlanCreator", "PmsSdk");
