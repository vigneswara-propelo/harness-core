...
public class NexusServerException extends WingsException {
  private static final String MESSAGE_KEY = "message";

  public NexusServerException(String message, ErrorCode code, EnumSet<ReportTarget> reportTargets) {
  ...
  public NexusServerException(String message, ErrorCode code) {
