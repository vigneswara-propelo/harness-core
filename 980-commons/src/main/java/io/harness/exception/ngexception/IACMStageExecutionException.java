...
public class IACMStageExecutionException extends WingsException {
  private static final String MESSAGE_KEY = "message";

  public IACMStageExecutionException(String message) {
    super(message, null, NG_PIPELINE_EXECUTION_EXCEPTION, Level.ERROR, null, null);
    param(MESSAGE_KEY, message);
  }

  public IACMStageExecutionException(String message, Throwable cause) {
