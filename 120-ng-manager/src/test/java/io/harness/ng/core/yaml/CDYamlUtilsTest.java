...
public class CDYamlUtilsTest extends CategoryTest {
  ...
  public void testWriteString() throws IOException {
    ...
    assertThat(CDYamlUtils.writeString(map).replaceFirst("---\n", "")).isEqualTo(resolvedPipelineYaml);
    ...
    assertThat(CDYamlUtils.writeString(Map.of("k", "Some \n Name")).replaceFirst("---\n", ""))
        .isEqualTo("k: \"Some \\n Name\"\n");
    assertThat(CDYamlUtils.writeString(Map.of("k", new TextNode("abc"))).replaceFirst("---\n", ""))
        .isEqualTo("k: abc\n");
    assertThat(CDYamlUtils.writeString(Map.of("k", new TextNode("+1234"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234\"\n");
    assertThat(CDYamlUtils.writeString(Map.of("k", new TextNode("+1234.12"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234.12\"\n");
    assertThat(CDYamlUtils.writeString(Map.of("k", new TextNode("+1234."))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234.\"\n");
    assertThat(CDYamlUtils.writeString(Map.of("k", new TextNode("+.12"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+.12\"\n");
  }
  ...
  public void testWriteYamlString() throws IOException {
    ...
    String resolvedPipelineYaml = Resources.toString(
        Objects.requireNonNull(classLoader.getResource(resolvedPipelineYamlFilename)), StandardCharsets.UTF_8);
    assertThat(CDYamlUtils.writeYamlString(map)).isEqualTo(resolvedPipelineYaml);
    ...
    map.put("k1", "abc");
    map.put("k2", new TextNode("42e4"));
    assertThat(CDYamlUtils.writeYamlString(map)).isEqualTo("k1: abc\nk2: \"42e4\"\n");
    ...
    assertThat(CDYamlUtils.writeYamlString(Map.of("k",
        ...
        .isEqualTo("k: |-\n"
            ...
            + "  foo\n"
            + "  bar\n");
    assertThat(CDYamlUtils.writeYamlString(Map.of("k", new TextNode("abc")))).isEqualTo("k: abc\n");
    assertThat(CDYamlUtils.writeYamlString(Map.of("k", new TextNode("+1234")))).isEqualTo("k: \"+1234\"\n");
    assertThat(CDYamlUtils.writeYamlString(Map.of("k", new TextNode("+1234.12")))).isEqualTo("k: \"+1234.12\"\n");
    assertThat(CDYamlUtils.writeYamlString(Map.of("k", new TextNode("+1234.")))).isEqualTo("k: \"+1234.\"\n");
    assertThat(CDYamlUtils.writeYamlString(Map.of("k", new TextNode("+.12")))).isEqualTo("k: \"+.12\"\n");
  }
}
