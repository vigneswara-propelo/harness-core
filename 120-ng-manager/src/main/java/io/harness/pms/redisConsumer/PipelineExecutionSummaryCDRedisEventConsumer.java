...
@OwnedBy(PIPELINE)
@Singleton
public class PipelineExecutionSummaryCDRedisEventConsumer
    extends PmsAbstractRedisConsumer<PipelineExecutionSummaryCDRedisEventMessageListener> {
  @Inject
  public PipelineExecutionSummaryCDRedisEventConsumer(
      ...
      PipelineExecutionSummaryCDRedisEventMessageListener pipelineExecutionSummaryCDRedisEventMessageListener,
      @Named("sdkEventsCache") Cache<String, Integer> eventsCache, QueueController queueController) {
    super(redisConsumer, pipelineExecutionSummaryCDRedisEventMessageListener, eventsCache, queueController);
  }
}
