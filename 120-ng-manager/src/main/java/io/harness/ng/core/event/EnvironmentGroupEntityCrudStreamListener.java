...
public class EnvironmentGroupEntityCrudStreamListener implements MessageListener {
  private final EnvironmentGroupService environmentGroupService;

  @Inject
  public EnvironmentGroupEntityCrudStreamListener(EnvironmentGroupService environmentGroupService) {
