...
@OwnedBy(PL)
public class ApiTokenRestrictionUsageImpl implements RestrictionUsageInterface<StaticLimitRestrictionMetadataDTO> {
  @Inject TokenService tokenService;

  @Override
  public long getCurrentValue(String accountIdentifier, StaticLimitRestrictionMetadataDTO restrictionMetadataDTO) {
    return tokenService.countApiTokens(accountIdentifier);
  }
}
