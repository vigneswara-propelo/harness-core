...
public class TerragruntConfigEntityCRUDStreamListener implements MessageListener {
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    return terragruntConfigEntityCRUDEventHandler.deleteAssociatedTerragruntConfigForAccount(
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    return terragruntConfigEntityCRUDEventHandler.deleteAssociatedTerragruntConfigForOrganization(
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    return terragruntConfigEntityCRUDEventHandler.deleteAssociatedTerragruntConfigForProject(
