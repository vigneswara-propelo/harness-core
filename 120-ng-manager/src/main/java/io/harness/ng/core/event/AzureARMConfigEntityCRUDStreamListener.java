...
@Slf4j
@Singleton
public class AzureARMConfigEntityCRUDStreamListener implements MessageListener {
  private final AzureARMConfigEntityCRUDEventHandler azureARMConfigEntityCRUDEventHandler;

  @Inject
  public AzureARMConfigEntityCRUDStreamListener(
      AzureARMConfigEntityCRUDEventHandler azureARMConfigEntityCRUDEventHandler) {
    this.azureARMConfigEntityCRUDEventHandler = azureARMConfigEntityCRUDEventHandler;
  }
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    return azureARMConfigEntityCRUDEventHandler.deleteAssociatedAzureARMConfigForAccount(
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    return azureARMConfigEntityCRUDEventHandler.deleteAssociatedAzureARMConfigForOrganization(
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    return azureARMConfigEntityCRUDEventHandler.deleteAssociatedAzureARMConfigForProject(
