...
@Slf4j
@Singleton
public class InstanceDeploymentInfoCRUDStreamListener implements MessageListener {
  private final InstanceDeploymentInfoRepository instanceDeploymentInfoRepository;
  @Inject
  public InstanceDeploymentInfoCRUDStreamListener(InstanceDeploymentInfoRepository instanceDeploymentInfoRepository) {
    this.instanceDeploymentInfoRepository = instanceDeploymentInfoRepository;
  }
  ...
  private boolean processProjectDeleteEvent(ProjectEntityChangeDTO projectEntityChangeDTO) {
    return instanceDeploymentInfoRepository.deleteByScope(Scope.of(projectEntityChangeDTO.getAccountIdentifier(),
