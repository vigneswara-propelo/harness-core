...
@Slf4j
@Singleton
public class TerraformConfigEntityCRUDStreamListener implements MessageListener {
  private final TerraformConfigEntityCRUDEventHandler terraformConfigEntityCRUDEventHandler;

  @Inject
  public TerraformConfigEntityCRUDStreamListener(
      TerraformConfigEntityCRUDEventHandler terraformConfigEntityCRUDEventHandler) {
    this.terraformConfigEntityCRUDEventHandler = terraformConfigEntityCRUDEventHandler;
  }
  ...
  private boolean processAccountChangeEvent(Message message) {
    ...
    return terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForAccount(
  ...
  private boolean processOrganizationChangeEvent(Message message) {
    ...
    return terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForOrganization(
  ...
  private boolean processProjectChangeEvent(Message message) {
    ...
    return terraformConfigEntityCRUDEventHandler.deleteAssociatedTerraformConfigForProject(
