...
@Slf4j
public class GenerateOpenApiSpecCommand extends ConfiguredCommand<NextGenConfiguration> {
  ...
  @Override
  protected void run(Bootstrap<NextGenConfiguration> bootstrap, Namespace namespace, NextGenConfiguration configuration)
      throws Exception {
