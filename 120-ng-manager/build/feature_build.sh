...
chmod +x 120-ng-manager/build/build_jar.sh
chmod +x 120-ng-manager/build/build_dist.sh

120-ng-manager/build/build_jar.sh
120-ng-manager/build/build_dist.sh || true
