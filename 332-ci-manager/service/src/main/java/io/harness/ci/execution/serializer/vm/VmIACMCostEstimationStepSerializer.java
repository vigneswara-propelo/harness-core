...
@Singleton
public class VmIACMCostEstimationStepSerializer {
  ...
  public VmPluginStep serialize(Ambiance ambiance, IACMCostEstimationInfo stepInfo, StageInfraDetails stageInfraDetails,
