...
@OwnedBy(IACM)
public class VmIACMCostEstimationStepSerializerTest {
  ...
  @InjectMocks private VmIACMCostEstimationStepSerializer vmIACMCostEstimationStepSerializer;
  ...
  public void testIACMGetWorkspaceVariables() {
    ...
    IACMCostEstimationInfo stepInfo = IACMCostEstimationInfo.builder()
    ...
    VmPluginStep vmPluginStep = vmIACMCostEstimationStepSerializer.serialize(ambiance, stepInfo, null, null);
