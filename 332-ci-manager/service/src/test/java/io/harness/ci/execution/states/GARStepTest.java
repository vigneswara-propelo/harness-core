...
public class GARStepTest extends CIExecutionTestBase {
  @InjectMocks GARStep garStep;
  ...
  public static final String STEP_ID = "garStepID";
  ...
  public void setUp() {
    ...
    GARStepInfo stepInfo = GARStepInfo.builder()
                               .identifier(STEP_ID)
                               .projectID(ParameterField.createValueField("project-id"))
                               .host(ParameterField.createValueField("us.docker.pkg.dev"))
    ...
    ArtifactMetadata artifactMetadata =
        ArtifactMetadata.builder()
            ...
            .spec(DockerArtifactMetadata.builder()
                      ...
                      .build())
            .build();
    StepArtifacts stepArtifacts = garStep.handleArtifact(artifactMetadata, stepElementParameters);
    ...
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(
            PublishedImageArtifact.builder()
                ...
                .tag("1.0")
                .url(
                    "https://console.cloud.google.com/artifacts/docker/harness/US/harness/ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70?project=harness")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70")
                .build(),
            PublishedImageArtifact.builder()
                .imageName("harness/ci-automation")
                .tag("latest")
                .url(
                    "https://console.cloud.google.com/artifacts/docker/harness/US/harness/ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71?project=harness")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71")
                .build());
  }
  ...
  public void shouldHandleArtifactWithGlobalURL() {
    StepElementParameters stepElementParameters =
        StepElementParameters.builder()
            .identifier("stepId")
            .spec(GARStepInfo.builder()
                      .host(ParameterField.createValueField("docker.pkg.dev"))
                      .projectID(ParameterField.createValueField("harness"))
                      .imageName(ParameterField.createValueField("ci-unittest"))
                      .tags(ParameterField.createValueField(Arrays.asList("1.0", "latest")))
                      .build())
    ...
    assertThat(stepArtifacts.getPublishedImageArtifacts())
        .contains(
            PublishedImageArtifact.builder()
                ...
                .tag("1.0")
                .url(
                    "https://console.cloud.google.com/artifacts/docker/harness/GLOBAL/harness/ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70?project=harness")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f70")
                .build(),
            PublishedImageArtifact.builder()
                .imageName("harness/ci-automation")
                .tag("latest")
                .url(
                    "https://console.cloud.google.com/artifacts/docker/harness/GLOBAL/harness/ci-automation@sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71?project=harness")
                .digest("sha256:49f756463ad9dcfb9b6ade54d7d6f15476e7214f46a65b4b0c55d46845b12f71")
                .build());
  }
  ...
  public void shouldHandleSuccessVMAsyncResponseWithArtifacts() {
    ...
    String artifact = k8InitializeStepUtilsHelper.readFile("gar-artifact.json");
    ...
    PublishedImageArtifact expectedArtifact =
        PublishedImageArtifact.builder()
            ...
            .tag("1.0")
            .url(
                "https://console.cloud.google.com/artifacts/docker/project-id/US/test@sha256:digest?project=project-id")
    ...
    StepResponse stepResponse = garStep.handleAsyncResponse(ambiance, stepElementParameters, responseDataMap);
