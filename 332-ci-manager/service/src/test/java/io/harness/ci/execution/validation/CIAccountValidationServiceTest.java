...
public class CIAccountValidationServiceTest extends CIExecutionTestBase {
  ...
  public void setup() {
    initMocks(this);
    when(executionLimits.getFreeBasicUser()).thenReturn(ExecutionLimitSpec.builder().dailyMaxBuildsCount(25).build());
    when(executionLimits.getFreeNewUser()).thenReturn(ExecutionLimitSpec.builder().dailyMaxBuildsCount(0).build());
  }
