...
@OwnedBy(CI)
@RecasterAlias("io.harness.beans.steps.stepinfo.ActionStepInfo")
public class ActionStepInfo implements CIStepInfo, WithConnectorRef {
  ...
  @JsonIgnore public static final TypeInfo typeInfo = TypeInfo.builder().stepInfoType(CIStepInfoType.ACTION).build();

  @JsonIgnore
  public static final StepType STEP_TYPE =
      StepType.newBuilder().setType(CIStepInfoType.ACTION.getDisplayName()).setStepCategory(StepCategory.STEP).build();
