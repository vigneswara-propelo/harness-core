...
@OwnedBy(CI)
@RecasterAlias("io.harness.beans.steps.stepinfo.V1.BitriseStepInfoV1")
public class BitriseStepInfoV1 extends CIAbstractStepInfo implements WithConnectorRef {
  @JsonIgnore
  public static final TypeInfo typeInfo = TypeInfo.builder().stepInfoType(CIStepInfoType.BITRISE_V1).build();

  @JsonIgnore
  public static final StepType STEP_TYPE = StepType.newBuilder()
                                               .setType(CIStepInfoType.BITRISE_V1.getDisplayName())
  ...
  public BitriseStepInfoV1(String uuid, ParameterField<String> uses, ParameterField<Map<String, String>> with,
