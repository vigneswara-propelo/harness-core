...
@JsonTypeName("host")
@OwnedBy(CI)
@RecasterAlias("io.harness.beans.yaml.extended.volumes.V1.HostVolume")
public class HostVolume implements Volume {
  ...
  @Builder
  @AllArgsConstructor
  public static class HostVolumeSpec implements Spec {
    @NotNull @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> target;
    @NotNull @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> source;
  }
}
