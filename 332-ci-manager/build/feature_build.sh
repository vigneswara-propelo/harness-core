...
chmod +x 332-ci-manager/build/build_jar.sh
chmod +x 332-ci-manager/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD 332-ci-manager/build.properties
332-ci-manager/build/build_jar.sh
332-ci-manager/build/build_dist.sh || true
