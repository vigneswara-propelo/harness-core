...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/f5203793 \
  && curl -s -L -o client-tools/scm/f5203793/scm https://app.harness.io/public/shared/tools/scm/release/f5203793/bin/linux/$ARCH/scm
else
