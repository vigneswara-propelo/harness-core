...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/140a857a \
  && curl -s -L -o client-tools/scm/140a857a/scm https://app.harness.io/public/shared/tools/scm/release/140a857a/bin/linux/amd64/scm
else
