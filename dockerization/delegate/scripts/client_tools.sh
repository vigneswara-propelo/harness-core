...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/519da179 \
  && curl -s -L -o client-tools/scm/519da179/scm https://app.harness.io/public/shared/tools/scm/release/519da179/bin/linux/amd64/scm
else
