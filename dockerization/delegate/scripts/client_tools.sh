...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/5652f13b \
  && curl -s -L -o client-tools/scm/5652f13b/scm https://app.harness.io/public/shared/tools/scm/release/298576b8/bin/linux/amd64/scm
else
