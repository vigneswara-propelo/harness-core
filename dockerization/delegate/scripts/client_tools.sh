...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/14bbb1d2 \
  && curl -s -L -o client-tools/scm/14bbb1d2/scm https://app.harness.io/public/shared/tools/scm/release/14bbb1d2/bin/linux/$ARCH/scm
else
