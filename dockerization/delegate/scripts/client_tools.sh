...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/e3ee71bd \
  && curl -s -L -o client-tools/scm/e3ee71bd/scm https://app.harness.io/public/shared/tools/scm/release/e3ee71bd/bin/linux/$ARCH/scm
else
