...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/e2904e73/linux/amd64 \
  && curl -s -L -o client-tools/scm/e2904e73/linux/amd64/scm https://app.harness.io/public/shared/tools/scm/release/e2904e73/bin/linux/amd64/scm
else
