...
@Slf4j
public class UpdateTimescaleTableCIWithTriggerInfo implements NGMigration {
  ...
  private String getFileName() {
    return "timescale/modify_pipeline_execution_summary_ci_trigger_info_timescale.sql";
  }
