...
public interface TriggerWebhookEventExecutionService extends PmsCommonsBaseEventHandler<TriggerExecutionDTO> {
  void processEvent(TriggerExecutionDTO triggerExecutionDTO);
}
