...
@OwnedBy(SPG)
@Singleton
public class PipelineExecutionSummaryRedisEventConsumer extends RedisTraceConsumer implements PmsRedisConsumer {
  ...
  private void readEventsFrameworkMessages() throws InterruptedException {
    try {
      ...
      log.error("Events framework is down for Pipeline Execution Summary Consumer. Retrying again...", e);
