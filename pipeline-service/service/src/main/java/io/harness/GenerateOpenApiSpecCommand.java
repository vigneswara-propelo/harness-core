...
@Slf4j
public class GenerateOpenApiSpecCommand extends ConfiguredCommand<PipelineServiceConfiguration> {
  ...
  @Override
  protected void run(Bootstrap<PipelineServiceConfiguration> bootstrap, Namespace namespace,
      PipelineServiceConfiguration configuration) throws Exception {
