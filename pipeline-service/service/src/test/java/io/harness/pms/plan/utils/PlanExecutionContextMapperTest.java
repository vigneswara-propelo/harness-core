...
public class PlanExecutionContextMapperTest extends CategoryTest {
  ...
  public void testCreatePlanExecutionContext() {
    ExecutionMetadata executionMetadata = ExecutionMetadata.newBuilder()
                                              ...
                                              .setHarnessVersion("0")
                                              .build();
    PlanExecutionContext planExecutionContext = PlanExecutionContextMapper.toExecutionContext(
        executionMetadata, Collections.singletonMap("K1", "V1"), Collections.singletonMap("K1", true));
    ...
    assertThat(planExecutionContext.getFeatureFlagToValueMapCount()).isEqualTo(1);
    assertThat(planExecutionContext.getSettingToValueMapCount()).isEqualTo(1);
  }
}