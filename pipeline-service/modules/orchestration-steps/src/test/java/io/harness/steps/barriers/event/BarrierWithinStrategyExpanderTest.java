...
public class BarrierWithinStrategyExpanderTest extends OrchestrationStepsTestBase {
  ...
  public void testOnInitializeRequest() {
    ...
    doNothing().when(barrierService).updateBarrierPositionInfoList(any(), any(), any());
    ...
    verify(barrierService, times(1))
        .updateBarrierPositionInfoList(eq(barrierIdentifier), eq(planExecutionId), updatedPositionsCaptor1.capture());
    ...
    verify(barrierService, times(2))
        .updateBarrierPositionInfoList(eq(barrierIdentifier), eq(planExecutionId), updatedPositionsCaptor2.capture());
