...
import static io.harness.ngtriggers.beans.source.webhook.v2.harness.event.HarnessTriggerEvent.PULL_REQUEST;
...
@OwnedBy(PIPELINE)
public class HarnessPRSpec implements HarnessEventSpec {
  String repoName;
  List<HarnessPRAction> actions;
