...
public class TriggerUpdateEvent implements Event {
  ...
  public Resource getResource() {
    ...
    labels.put(ResourceConstants.LABEL_KEY_RESOURCE_NAME, newTriggerEntity.getName());
    labels.put(ResourceConstants.LABEL_KEY_PIPELINE_IDENTIFIER, newTriggerEntity.getTargetIdentifier());
    labels.put("triggerType", newTriggerEntity.getType().toString());
    return Resource.builder()
        .identifier(newTriggerEntity.getIdentifier())
