...
@OwnedBy(PIPELINE)
public class PMSGitEntityOrderComparator implements GitSyncEntityOrderComparatorInMsvc {
  public static final List<EntityType> sortOrder = Lists.newArrayList(EntityType.PIPELINES, EntityType.INPUT_SETS);
