...
public abstract class SyncExecutableWithCapabilities implements SyncExecutableWithRbac<StepElementParameters> {
  @Override
  @SneakyThrows
  ...
  public abstract StepResponse executeSyncAfterRbac(Ambiance ambiance, StepElementParameters stepParameters,
      StepInputPackage inputPackage, PassThroughData passThroughData);
