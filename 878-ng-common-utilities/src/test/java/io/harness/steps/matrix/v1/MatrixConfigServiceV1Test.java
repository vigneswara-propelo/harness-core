...
public class MatrixConfigServiceV1Test extends CategoryTest {
  ...
  public void testFetchChildrenHavingFewSameCombinations() throws IOException {
    ...
    assertThat(children.get(0).getStrategyMetadata().getIdentifierPostFix()).isEqualTo("_0_0");
    assertThat(children.get(1).getStrategyMetadata().getIdentifierPostFix()).isEqualTo("_0_1");
    assertThat(children.get(2).getStrategyMetadata().getIdentifierPostFix()).isEqualTo("_1_0");
    assertThat(children.get(3).getStrategyMetadata().getIdentifierPostFix()).isEqualTo("_1_1");
  }
