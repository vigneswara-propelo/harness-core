  ...
  public void testToDataConnectionInfo() {
    ...
    PrometheusCVConfig.MetricInfo metricInfo =
        PrometheusCVConfig.MetricInfo.builder()
            ...
            .envFilter(Arrays.asList(
                PrometheusDSConfig.PrometheusFilter.builder().labelName("namespace").labelValue("cv-demo").build()))
            .serviceFilter(Arrays.asList(
                PrometheusDSConfig.PrometheusFilter.builder().labelName("app").labelValue("cv-demo-app").build()))
            .additionalFilters(Arrays.asList(
                PrometheusDSConfig.PrometheusFilter.builder().labelName("filter2").labelValue("cv-2").build(),
                PrometheusDSConfig.PrometheusFilter.builder().labelName("filter3").labelValue("cv-3").build()))
            .build();
