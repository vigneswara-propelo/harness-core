...
// TODO: Adding bare-minimum code to pass the unit test. Will be updated in next PR.
public class AwsPrometheusDataCollectionInfoMapper
  ...
  @Override
  protected CloudWatchMetricDataCollectionInfo toDataCollectionInfo(
      CloudWatchMetricCVConfig cvConfigWithFilteredMetricInfo) {
    return null;
  }
}
