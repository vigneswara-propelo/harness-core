...
public class ServiceLevelObjectiveErrorBudgetResetEvent extends AbstractServiceLevelObjectiveEvent {
  ...
  public String getEventType() {
    return ServiceLevelObjectiveEventTypes.ERROR_BUDGET_RESET.toString();
  }
}
