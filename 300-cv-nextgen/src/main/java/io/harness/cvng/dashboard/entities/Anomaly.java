  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        .add(CompoundMongoIndex.builder()
                 .name("insert_idx")
                 .field(AnomalyKeys.accountId)
                 .field(AnomalyKeys.projectIdentifier)
                 .field(AnomalyKeys.serviceIdentifier)
                 .field(AnomalyKeys.envIdentifier)
                 .field(AnomalyKeys.category)
