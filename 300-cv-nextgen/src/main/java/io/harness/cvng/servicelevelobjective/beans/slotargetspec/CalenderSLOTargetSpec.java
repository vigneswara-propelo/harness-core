...
public class CalenderSLOTargetSpec extends SLOTargetSpec {
  @NotNull @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd") Long startDate;
  @NotNull @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd") Long endDate;
