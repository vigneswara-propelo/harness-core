...
@Slf4j
public class GenerateOpenApiSpecCommand extends ConfiguredCommand<VerificationConfiguration> {
  ...
  @Override
  protected void run(Bootstrap<VerificationConfiguration> bootstrap, Namespace namespace,
      VerificationConfiguration configuration) throws Exception {
