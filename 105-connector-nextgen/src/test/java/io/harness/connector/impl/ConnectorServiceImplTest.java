...
public class ConnectorServiceImplTest extends ConnectorsBaseTest {
  ...
  public void testCreate() {
    ...
    ConnectorDTO connectorDTO = ConnectorDTO.builder()
                                    ...
                                    .build();
    ConnectorDTO connectorDTOOutput = connectorService.create(connectorDTO);
    ...
    KubernetesClusterConfigDTO kubernetesCluster = (KubernetesClusterConfigDTO) connectorDTO.getConnectorConfig();
