...
public class ConnectorModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    connectorValidatorMapBinder.addBinding(ConnectorType.CE_AWS.getDisplayName()).to(CEAwsConnectorValidator.class);
    ...
    connectorDTOToEntityMapBinder.addBinding(ConnectorType.CE_AWS.getDisplayName()).to(CEAwsDTOToEntity.class);
    ...
    connectorEntityToDTOMapper.addBinding(ConnectorType.CE_AWS.getDisplayName()).to(CEAwsEntityToDTO.class);
