...
@Singleton
public class OciHelmConnectorValidationParamsProvider implements ConnectorValidationParamsProvider {
  ...
  public ConnectorValidationParams getConnectorValidationParams(ConnectorInfoDTO connectorInfoDTO, String connectorName,
    ...
    return OciHelmValidationParams.builder()
        .ociHelmConnectorDTO((OciHelmConnectorDTO) connectorConfigDTO)
