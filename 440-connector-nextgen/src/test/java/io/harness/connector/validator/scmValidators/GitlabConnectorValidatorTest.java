...
public class GitlabConnectorValidatorTest extends CategoryTest {
  ...
  public void validateTestViaManager() {
    ...
    when(connectorTypeToConnectorValidationHandlerMap.get(eq("Gitlab"))).thenReturn(gitValidationHandler);
    ...
    when(connectorValidationParamsProviderMap.get(eq("Gitlab"))).thenReturn(scmConnectorValidationParamsProvider);
