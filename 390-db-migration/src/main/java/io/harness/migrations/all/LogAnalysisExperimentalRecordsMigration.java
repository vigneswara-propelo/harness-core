...
public class LogAnalysisExperimentalRecordsMigration implements Migration {
  ...
  @Override
  public void migrate() {
    DBCollection collection = wingsPersistence.getCollection(ExperimentalLogMLAnalysisRecord.class);
    ...
    while (logAnalysisRecords.hasNext()) {
      ...
      bulkWriteOperation
          .find(wingsPersistence.createQuery(ExperimentalLogMLAnalysisRecord.class)
                    .filter(ID_KEY2, uuId)
                    .getQueryObject())
