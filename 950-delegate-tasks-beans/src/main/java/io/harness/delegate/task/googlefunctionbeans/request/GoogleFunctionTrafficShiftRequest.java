...
public class GoogleFunctionTrafficShiftRequest implements GoogleFunctionCommandRequest, NestedAnnotationResolver {
  ...
  @NonFinal @Expression(ALLOW_SECRETS) Integer targetTrafficPercent;
  @NonFinal @Expression(ALLOW_SECRETS) String targetRevision;
