...
@Value
@Builder
public class ServerlessArtifactoryArtifactConfig implements ServerlessArtifactConfig, NestedAnnotationResolver {
  ...
  public ServerlessArtifactType getServerlessArtifactType() {
    return ServerlessArtifactType.ARTIFACTORY;
  }
}
