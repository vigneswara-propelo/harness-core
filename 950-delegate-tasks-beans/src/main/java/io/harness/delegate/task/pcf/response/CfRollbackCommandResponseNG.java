...
public class CfRollbackCommandResponseNG implements CfCommandResponseNG {
  ...
  public StepExecutionInstanceInfo getStepExecutionInstanceInfo() {
    if (isNull(this.cfRollbackCommandResult)) {
    ...
    return StepExecutionInstanceInfo.builder()
        .serviceInstancesBefore(
            convertTasApplicationToTasStepInstanceInfo(this.cfRollbackCommandResult.getCurrentProdInfo()))
        .deployedServiceInstances(
            convertTasApplicationToTasStepInstanceInfo(this.cfRollbackCommandResult.getNewApplicationInfo()))
