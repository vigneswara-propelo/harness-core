...
@RecasterAlias("io.harness.delegate.beans.instancesync.info.AzureSshWinrmServerInstanceInfo")
public class AzureSshWinrmServerInstanceInfo extends SshWinrmServerInstanceInfo {
  @Builder
  public AzureSshWinrmServerInstanceInfo(String serviceType, String infrastructureKey, String host) {
