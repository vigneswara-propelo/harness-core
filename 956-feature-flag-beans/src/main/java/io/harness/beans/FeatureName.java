...
public enum FeatureName {
  ...
  PLANS_ENABLED(Scope.GLOBAL),
  FEATURE_ENFORCEMENT_ENABLED(Scope.GLOBAL),
  FREE_PLAN_ENABLED(Scope.GLOBAL),
  NG_GIT_FULL_SYNC,
  ...
  AZURE_CLOUD_PROVIDER_VALIDATION_ON_DELEGATE,
  AMI_ASG_CONFIG_COPY,
