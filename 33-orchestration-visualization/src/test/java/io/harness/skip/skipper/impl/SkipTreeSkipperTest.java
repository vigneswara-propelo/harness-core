...
public class SkipTreeSkipperTest extends OrchestrationVisualizationTestBase {
  ...
  public void shouldRemoveSubgraphWithPrevAndNextPresent() {
    ...
    GraphVertex current = GraphVertex.builder().uuid(generateUuid()).name("current").skipType(SKIP_TREE).build();
    ...
    skipTreeSkipper.skip(orchestrationGraph, current);
    ...
    assertThat(updatedGraphVertexMap.values()).containsExactlyInAnyOrder(previous, next);
    ...
    assertThat(updatedAdjacencyList.keySet()).containsExactlyInAnyOrder(previous.getUuid(), next.getUuid());

    assertThat(updatedAdjacencyList.get(previous.getUuid()).getNextIds()).containsExactlyInAnyOrder(next.getUuid());
    ...
    assertThat(updatedAdjacencyList.get(next.getUuid()).getPrevIds()).containsExactlyInAnyOrder(previous.getUuid());
  }
  ...
  public void shouldRemoveSubgraphWhenCurrentIsRootNode() {
    ...
    assertThat(orchestrationGraph.getRootNodeIds()).containsExactlyInAnyOrder(next.getUuid());
    ...
    Map<String, GraphVertex> updatedGraphVertexMap = updatedOrchestrationAdjacencyListInternal.getGraphVertexMap();
    assertThat(updatedGraphVertexMap).isNotEmpty();
    assertThat(updatedGraphVertexMap.values()).containsExactlyInAnyOrder(next);

    Map<String, EdgeListInternal> updatedAdjacencyList = updatedOrchestrationAdjacencyListInternal.getAdjacencyMap();
    assertThat(updatedAdjacencyList).isNotEmpty();
    assertThat(updatedAdjacencyList.keySet()).containsExactlyInAnyOrder(next.getUuid());

    assertThat(updatedAdjacencyList.get(next.getUuid()).getNextIds()).isEmpty();
    assertThat(updatedAdjacencyList.get(next.getUuid()).getEdges()).isEmpty();
    assertThat(updatedAdjacencyList.get(next.getUuid()).getParentId()).isNull();
    assertThat(updatedAdjacencyList.get(next.getUuid()).getPrevIds()).isEmpty();
  }

  @Test
  @Owner(developers = ALEXEI)
  @Category(UnitTests.class)
  public void shouldRemoveSubgraphWhenCurrentHasParentAndNext() {
    ...
    Map<String, GraphVertex> updatedGraphVertexMap = updatedOrchestrationAdjacencyListInternal.getGraphVertexMap();
    assertThat(updatedGraphVertexMap).isNotEmpty();
    assertThat(updatedGraphVertexMap.values()).containsExactlyInAnyOrder(parent, next);

    Map<String, EdgeListInternal> updatedAdjacencyList = updatedOrchestrationAdjacencyListInternal.getAdjacencyMap();
    assertThat(updatedAdjacencyList).isNotEmpty();
    assertThat(updatedAdjacencyList.keySet()).containsExactlyInAnyOrder(parent.getUuid(), next.getUuid());

    assertThat(updatedAdjacencyList.get(parent.getUuid()).getNextIds()).isEmpty();
    assertThat(updatedAdjacencyList.get(parent.getUuid()).getEdges()).containsExactlyInAnyOrder(next.getUuid());
    ...
    assertThat(updatedAdjacencyList.get(next.getUuid()).getNextIds()).isEmpty();
    assertThat(updatedAdjacencyList.get(next.getUuid()).getEdges()).isEmpty();
    assertThat(updatedAdjacencyList.get(next.getUuid()).getParentId()).isEqualTo(parent.getUuid());
    assertThat(updatedAdjacencyList.get(next.getUuid()).getPrevIds()).isEmpty();
  }
}
