...
package io.harness.ngmigration.metrics;
...
@Slf4j
public class NGMigrationDwMetricsPublisher implements MetricsPublisher {
  ...
  private static final String SERVICE_NAME = "migrator-service";
