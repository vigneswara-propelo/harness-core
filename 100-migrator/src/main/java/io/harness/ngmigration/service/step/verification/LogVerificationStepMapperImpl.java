...
public class LogVerificationStepMapperImpl extends VerificationBaseService {
  @Override
  public State getState(GraphNode stepYaml) {
    Map<String, Object> properties = super.getProperties(stepYaml);
    CustomLogVerificationState state = new CustomLogVerificationState(stepYaml.getName());
