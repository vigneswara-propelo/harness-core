...
import static io.harness.ngmigration.utils.NGMigrationConstants.LONG_RELEASE_NAME;
...
public class NativeHelmInfraDefMapper implements InfraDefMapper {
  ...
  public Infrastructure getSpec(MigrationContext migrationContext, InfrastructureDefinition infrastructureDefinition,
    ...
    ParameterField<String> releaseName = isEnabled(Flag.HELM_INFRA_WITH_STAGE_VAR)
        ...
        : (isEnabled(Flag.LONG_RELEASE_NAME) ? ParameterField.createValueField(LONG_RELEASE_NAME)
