...
@Getter
@NoArgsConstructor
public class FileCreateEvent implements Event {
  public static final String FILE_CREATED_EVENT = "FileCreated";
  private FileDTO file;
  private String accountIdentifier;

  @Builder
  public FileCreateEvent(String accountIdentifier, FileDTO file) {
    this.file = file;
