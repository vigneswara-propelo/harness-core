...
/**
 * Protobuf type {@code io.harness.perpetualtask.k8s.watch.PodEvent}
 */
@javax.annotation.Generated(value = "protoc", comments = "annotations:PodEvent.java.pb.meta")
public final class PodEvent extends com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:io.harness.perpetualtask.k8s.watch.PodEvent)
    PodEventOrBuilder {
  private static final long serialVersionUID = 0L;
  // Use PodEvent.newBuilder() to construct.
  private PodEvent(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private PodEvent() {
    cloudProviderId_ = "";
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
    return io.harness.perpetualtask.k8s.watch.K8SMessages
        .internal_static_io_harness_perpetualtask_k8s_watch_PodEvent_fieldAccessorTable.ensureFieldAccessorsInitialized(
            io.harness.perpetualtask.k8s.watch.PodEvent.class,
            io.harness.perpetualtask.k8s.watch.PodEvent.Builder.class);
  }

  /**
   * Protobuf enum {@code io.harness.perpetualtask.k8s.watch.PodEvent.EventType}
   */
  ...
  .google.protobuf.ProtocolMessageEnum {
    ...
    EVENT_TYPE_INVALID(0),
        /**
         * <code>EVENT_TYPE_SCHEDULED = 1;</code>
         */
    ...
    public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
      return io.harness.perpetualtask.k8s.watch.PodEvent.getDescriptor().getEnumTypes().get(0);
    }
    ...
    // @@protoc_insertion_point(enum_scope:io.harness.perpetualtask.k8s.watch.PodEvent.EventType)
  }
  ...
  public io.harness.perpetualtask.k8s.watch.PodEvent.EventType getType() {
    ...
    io.harness.perpetualtask.k8s.watch.PodEvent.EventType result =
        io.harness.perpetualtask.k8s.watch.PodEvent.EventType.valueOf(type_);
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (type_ != io.harness.perpetualtask.k8s.watch.PodEvent.EventType.EVENT_TYPE_INVALID.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.harness.perpetualtask.k8s.watch.PodEvent)) {
      return super.equals(obj);
    }
    io.harness.perpetualtask.k8s.watch.PodEvent other = (io.harness.perpetualtask.k8s.watch.PodEvent) obj;
  ...
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(java.nio.ByteBuffer data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(
      java.nio.ByteBuffer data, com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data, extensionRegistry);
  }
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(com.google.protobuf.ByteString data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(
  ...
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(
  ...
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(java.io.InputStream input)
  ...
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(com.google.protobuf.CodedInputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
  }
  public static io.harness.perpetualtask.k8s.watch.PodEvent parseFrom(com.google.protobuf.CodedInputStream input,
  ...
  public static Builder newBuilder(io.harness.perpetualtask.k8s.watch.PodEvent prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
      // @@protoc_insertion_point(builder_implements:io.harness.perpetualtask.k8s.watch.PodEvent)
      io.harness.perpetualtask.k8s.watch.PodEventOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return io.harness.perpetualtask.k8s.watch.K8SMessages
          .internal_static_io_harness_perpetualtask_k8s_watch_PodEvent_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return io.harness.perpetualtask.k8s.watch.K8SMessages
          ...
          .ensureFieldAccessorsInitialized(io.harness.perpetualtask.k8s.watch.PodEvent.class,
              io.harness.perpetualtask.k8s.watch.PodEvent.Builder.class);
    }

    // Construct using io.harness.perpetualtask.k8s.watch.PodEvent.newBuilder()
    private Builder() {
    ...
    @java.
    lang.Override
    public io.harness.perpetualtask.k8s.watch.PodEvent getDefaultInstanceForType() {
      return io.harness.perpetualtask.k8s.watch.PodEvent.getDefaultInstance();
    }

    @java.
    lang.Override
    public io.harness.perpetualtask.k8s.watch.PodEvent build() {
      io.harness.perpetualtask.k8s.watch.PodEvent result = buildPartial();
    ...
    @java.
    lang.Override
    public io.harness.perpetualtask.k8s.watch.PodEvent buildPartial() {
      io.harness.perpetualtask.k8s.watch.PodEvent result = new io.harness.perpetualtask.k8s.watch.PodEvent(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.harness.perpetualtask.k8s.watch.PodEvent) {
        return mergeFrom((io.harness.perpetualtask.k8s.watch.PodEvent) other);
      } else {
    ...
    public Builder mergeFrom(io.harness.perpetualtask.k8s.watch.PodEvent other) {
      if (other == io.harness.perpetualtask.k8s.watch.PodEvent.getDefaultInstance())
        return this;
    ...
    public Builder mergeFrom(com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry) throws java.io.IOException {
      io.harness.perpetualtask.k8s.watch.PodEvent parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (io.harness.perpetualtask.k8s.watch.PodEvent) e.getUnfinishedMessage();
    ...
    // @@protoc_insertion_point(builder_scope:io.harness.perpetualtask.k8s.watch.PodEvent)
  }

  // @@protoc_insertion_point(class_scope:io.harness.perpetualtask.k8s.watch.PodEvent)
  private static final io.harness.perpetualtask.k8s.watch.PodEvent DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.harness.perpetualtask.k8s.watch.PodEvent();
  }

  public static io.harness.perpetualtask.k8s.watch.PodEvent getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<PodEvent> PARSER =
      new com.google.protobuf.AbstractParser<PodEvent>() {
        @java.lang.Override
        public PodEvent parsePartialFrom(
            com.google.protobuf.CodedInputStream input, com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
          return new PodEvent(input, extensionRegistry);
        }
      };

  public static com.google.protobuf.Parser<PodEvent> parser() {
    return PARSER;
  }

  @java.
  lang.Override
  public com.google.protobuf.Parser<PodEvent> getParserForType() {
    return PARSER;
  }
