...
public class CapabilityUtils {
  ...
  private static Set<String> taskTypesMigratedToCapabilityFrameworkPhase2 = new HashSet<>(Arrays.asList("AWS_S3_TASK",
      ...
      "KMS_DECRYPT", "GCP_KMS_ENCRYPT", "VAULT_ENCRYPT", "VAULT_DECRYPT", "VAULT_DELETE_SECRET", "VAULT_GET_CHANGELOG",
      "VAULT_RENEW_TOKEN", "VAULT_APPROVE_LOGIN", "VAULT_LIST_ENGINES", "ASM_ENCRYPT", "ASM_DECRYPT",
      "ASM_DELETE_SECRET", "AZURE_VAULT_ENCRYPT", "AZURE_VAULT_DECRYPT", "AZURE_VAULT_DELETE", "SECRET_DECRYPT",
      "SECRET_DECRYPT_REF", "BATCH_SECRET_DECRYPT", "CYBERARK_DECRYPT", "CYBERARK_VALIDATE_CONFIG"));
