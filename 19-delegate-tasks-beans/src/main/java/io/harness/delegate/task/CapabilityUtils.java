...
public class CapabilityUtils {
  private static Set<String> taskTypesMigratedToCapabilityFramework = new HashSet<>(Arrays.asList("JENKINS",
      ...
      "ELK_COLLECT_24_7_LOG_DATA", "LOGZ_CONFIGURATION_VALIDATE_TASK", "LOGZ_COLLECT_LOG_DATA", "LOGZ_GET_LOG_SAMPLE",
      ...
      "HELM_REPO_CONFIG_VALIDATION", "HELM_VALUES_FETCH",

      "JIRA",

      "COLLABORATION_PROVIDER_TASK",

      "ACR_GET_BUILDS", "ACR_VALIDATE_ARTIFACT_STREAM", "ACR_GET_PLANS", "ACR_GET_ARTIFACT_PATHS",
      ...
      "K8S_COMMAND_TASK", "COMMAND", "HOST_VALIDATION", "CONNECTIVITY_VALIDATION"
