...
public class CapabilityUtils {
  ...
  private static Set<String> taskTypesMigratedToCapabilityFrameworkPhase2 = new HashSet<>(Arrays.asList(
      // CDC
      "FETCH_MASTER_URL", "AZURE_ARTIFACTS_VALIDATE_ARTIFACT_SERVER",

      // CV
      "SPLUNK_COLLECT_LOG_DATAV2", "NEWRELIC_COLLECT_METRIC_DATAV2", "INSTANA_COLLECT_METRIC_DATA",
      "ELK_COLLECT_LOG_DATAV2", "APPDYNAMICS_COLLECT_METRIC_DATA_V2", "INSTANA_VALIDATE_CONFIGURATION_TASK",
      "STACKDRIVER_LOG_DATA_FOR_NODE", "STACKDRIVER_GET_LOG_SAMPLE", "INSTANA_GET_INFRA_METRICS",
      "INSTANA_GET_TRACE_METRICS", "INSTANA_VALIDATE_CONFIGURATION_TASK", "CUSTOM_APM_COLLECT_METRICS_V2",

      // CDP
      "GIT_FETCH_FILES_TASK", "SPOTINST_COMMAND_TASK", "K8S_WATCH_TASK", "SHELL_SCRIPT_PROVISION_TASK",
      "CLOUD_WATCH_GENERIC_METRIC_STATISTICS", "GIT_COMMAND",

      // PLATFORM
      "KMS_ENCRYPT", "KMS_DECRYPT", "GCP_KMS_ENCRYPT", "GCP_KMS_DECRYPT", "VAULT_ENCRYPT", "VAULT_DECRYPT",
      "VAULT_DELETE_SECRET", "VAULT_GET_CHANGELOG", "VAULT_RENEW_TOKEN", "VAULT_APPROLE_LOGIN", "VAULT_LIST_ENGINES",
      "ASM_ENCRYPT", "ASM_DECRYPT", "ASM_DELETE_SECRET", "AZURE_VAULT_ENCRYPT", "AZURE_VAULT_DECRYPT",
      "AZURE_VAULT_DELETE", "SECRET_DECRYPT", "SECRET_DECRYPT_REF", "BATCH_SECRET_DECRYPT", "CYBERARK_DECRYPT",
      "CYBERARK_VALIDATE_CONFIG", "VAULT_APPROLE_LOGIN"));
