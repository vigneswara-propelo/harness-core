...
public class CapabilityUtils {
  private static Set<String> taskTypesMigratedToCapabilityFramework = new HashSet<>(Arrays.asList(
      ...
      //
      //      "SUMO_COLLECT_LOG_DATA", "SUMO_VALIDATE_CONFIGURATION_TASK", "SUMO_GET_HOST_RECORDS",
      //      "SUMO_GET_LOG_DATA_BY_HOST", "SUMO_COLLECT_24_7_LOG_DATA",
      //
      //      "ELK_CONFIGURATION_VALIDATE_TASK", "ELK_COLLECT_LOG_DATA", "ELK_COLLECT_INDICES", "ELK_GET_LOG_SAMPLE",
      //      "ELK_GET_HOST_RECORDS", "KIBANA_GET_VERSION",
      //
      //      "ELK_COLLECT_24_7_LOG_DATA", "LOGZ_CONFIGURATION_VALIDATE_TASK", "LOGZ_COLLECT_LOG_DATA",
      //      "LOGZ_GET_LOG_SAMPLE", "LOGZ_GET_HOST_RECORDS",
      //
      ...
      //      "NEWRELIC_COLLECT_24_7_METRIC_DATA", "NEWRELIC_GET_TXNS_WITH_DATA",
      //      "NEWRELIC_GET_TXNS_WITH_DATA_FOR_NODE", "NEWRELIC_POST_DEPLOYMENT_MARKER",
      //
      ...
      //      "STACKDRIVER_LIST_FORWARDING_RULES", "STACKDRIVER_COLLECT_24_7_METRIC_DATA",
      //      "STACKDRIVER_COLLECT_LOG_DATA", "STACKDRIVER_COLLECT_24_7_LOG_DATA",
      //
      ...
      //
      //
      //      "LDAP_TEST_CONN_SETTINGS", "LDAP_TEST_USER_SETTINGS", "LDAP_TEST_GROUP_SETTINGS",
      //      "LDAP_VALIDATE_SETTINGS", "LDAP_AUTHENTICATION", "LDAP_SEARCH_GROUPS", "LDAP_FETCH_GROUP",
      //
      //      "PCF_COMMAND_TASK",
      //
      //      "COLLABORATION_PROVIDER_TASK",
      //
      //      "SERVICENOW_ASYNC", "SERVICENOW_SYNC", "SERVICENOW_VALIDATION",
      //
      //
      ...
      //
      //      "CLOUD_WATCH_COLLECT_METRIC_DATA", "CLOUD_WATCH_METRIC_DATA_FOR_NODE",
      //      "CLOUD_WATCH_COLLECT_24_7_METRIC_DATA",
      //
      //      "CLOUD_FORMATION_TASK",
      //
      //      "ECS_STEADY_STATE_CHECK_TASK", "AWS_ECR_TASK", "AWS_ELB_TASK", "AWS_ECS_TASK", "AWS_IAM_TASK",
      //      "AWS_EC2_TASK", "AWS_ASG_TASK", "AWS_CODE_DEPLOY_TASK", "AWS_LAMBDA_TASK", "AWS_AMI_ASYNC_TASK",
      //      "AWS_CF_TASK", "AWS_ROUTE53_TASK", "AMI_GET_BUILDS", "ECS_COMMAND_TASK",
      //
      ...
      //
      //      "K8S_COMMAND_TASK", "COMMAND", "HOST_VALIDATION", "CONNECTIVITY_VALIDATION", "CONTAINER_INFO",
      //
      //      "TRIGGER_TASK",
      //
      //      "BUILD_SOURCE_TASK"
