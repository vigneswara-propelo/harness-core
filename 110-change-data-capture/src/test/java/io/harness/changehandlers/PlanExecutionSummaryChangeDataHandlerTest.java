...
public class PlanExecutionSummaryChangeDataHandlerTest extends CategoryTest {
  @Mock private TimeScaleDBService timeScaleDBService;
  @InjectMocks private PlanExecutionSummaryChangeDataHandler handler;
  ...
  public void testInsert() throws IOException, SQLException {
    ...
    handler.handleChange(changeEvent, "pipeline_execution_summary_ci", new String[] {});
  ...
  public void testInsertWithAuthor() throws IOException, SQLException {
    ...
    assertThat(sql).isEqualTo(
        "INSERT INTO pipeline_execution_summary_ci (author_name,moduleInfo_event,orgIdentifier,user_source,trigger_type,startTs,author_avatar,accountId,pipelineIdentifier,ciEditionType,name,endTs,moduleInfo_type,moduleInfo_author_id,id,projectIdentifier,planExecutionId,moduleinfo_branch_name,status) VALUES('test author','branch','Ng_Pipelines_K8s_Organisations','MANUAL','MANUAL','1670403351259','testavatar','OgiB4-xETamKNVAz-wQRjw','Azure_Web_Apps','ENTERPRISE','Azure Web Apps ','1670404155674','CI','testauthor','uuid','CdpNgGoldenPipelinesProject','iTDQmlTWRUGVlHiDIB5RTw','test_release','SUCCESS')");
  }
  ...
  public void testInsertWithEmptyCI() throws IOException, SQLException {
    ...
    final String sql = queryCaptor.getValue();
    assertThat(sql).isEqualTo(
        "INSERT INTO pipeline_execution_summary_ci (orgIdentifier,trigger_type,startTs,accountId,pipelineIdentifier,ciEditionType,name,endTs,moduleInfo_type,moduleInfo_author_id,id,projectIdentifier,planExecutionId,status) VALUES('Ng_Pipelines_K8s_Organisations','MANUAL','1670403351259','OgiB4-xETamKNVAz-wQRjw','Azure_Web_Apps','ENTERPRISE','Azure Web Apps ','1670404155674','CI','automationpipelinesng@mailinator.com','uuid','CdpNgGoldenPipelinesProject','iTDQmlTWRUGVlHiDIB5RTw','SUCCESS')");
  }
