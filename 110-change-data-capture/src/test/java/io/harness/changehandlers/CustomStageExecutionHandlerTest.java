...
public class CustomStageExecutionHandlerTest extends CategoryTest {
  @Mock private TimeScaleDBService timeScaleDBService;
  private CustomStageExecutionHandler handler = new CustomStageExecutionHandler();
  ...
  public void testInsert() throws IOException, SQLException {
    ...
    assertThat(sqls.get(0))
        .isEqualTo(
            "INSERT INTO custom_stage_execution (id,failure_message) VALUES('_bNe7lGaRbGTwrnlUMIiXQ','Approval Step has been Rejected')");
  }
