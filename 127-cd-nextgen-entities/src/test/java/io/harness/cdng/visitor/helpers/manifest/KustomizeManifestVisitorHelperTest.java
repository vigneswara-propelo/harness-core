...
@OwnedBy(CDP)
public class KustomizeManifestVisitorHelperTest extends CategoryTest {
  @Rule public MockitoRule mockitoRule = MockitoJUnit.rule();
  @Mock private FileStoreService fileStoreService;
  @InjectMocks private HarnessStoreVisitorHelper harnessStoreVisitorHelper;
  @Spy @InjectMocks private KustomizeManifestVisitorHelper kustomizeManifestVisitorHelper;

  @Test
  @Owner(developers = PRATYUSH)
  @Category(UnitTests.class)
  public void testAddReference() {
    Reflect.on(kustomizeManifestVisitorHelper).set("harnessStoreVisitorHelper", harnessStoreVisitorHelper);
    ...
    KustomizeManifest kustomizeManifest =
        KustomizeManifest.builder()
            ...
            .patchesPaths(ParameterField.createValueField(Collections.singletonList("/k8s/values.yaml")))
            .build();
    ...
    Set<EntityDetailProtoDTO> entityDetailProtoDTOS =
        kustomizeManifestVisitorHelper.addReference(kustomizeManifest, accountId, orgId, projectId, contextMap);
