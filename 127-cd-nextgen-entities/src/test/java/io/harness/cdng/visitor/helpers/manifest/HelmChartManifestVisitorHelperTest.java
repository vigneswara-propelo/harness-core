...
@OwnedBy(CDP)
public class HelmChartManifestVisitorHelperTest extends CategoryTest {
  @Rule public MockitoRule mockitoRule = MockitoJUnit.rule();
  @Mock private FileStoreService fileStoreService;
  @InjectMocks private HarnessStoreVisitorHelper harnessStoreVisitorHelper;
  @Spy @InjectMocks private HelmChartManifestVisitorHelper helmChartManifestVisitorHelper;

  @Test
  @Owner(developers = PRATYUSH)
  @Category(UnitTests.class)
  public void testAddReference() {
    Reflect.on(helmChartManifestVisitorHelper).set("harnessStoreVisitorHelper", harnessStoreVisitorHelper);
    ...
    Set<EntityDetailProtoDTO> entityDetailProtoDTOS =
        helmChartManifestVisitorHelper.addReference(helmChartManifest, accountId, orgId, projectId, contextMap);
