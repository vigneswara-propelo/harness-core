...
@TypeAlias("awsSamInfrastructure")
@RecasterAlias("io.harness.cdng.infra.yaml.AwsSamInfrastructure")
public class AwsSamInfrastructure
  ...
  public InfraMapping getInfraMapping() {
    return AwsSamInfraMapping.builder().awsConnector(connectorRef.getValue()).region(region.getValue()).build();
  }
  ...
  public Infrastructure applyOverrides(Infrastructure overrideConfig) {
    AwsSamInfrastructure config = (AwsSamInfrastructure) overrideConfig;
    AwsSamInfrastructure resultantInfra = this;
