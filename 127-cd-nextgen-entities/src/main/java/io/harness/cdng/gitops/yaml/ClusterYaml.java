...
public class ClusterYaml implements Visitable {
  ...
  // making it nullable for backward compatibility
  @ApiModelProperty(dataType = SwaggerConstants.STRING_CLASSPATH) private ParameterField<String> agentIdentifier;
}
