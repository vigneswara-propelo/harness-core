...
@JsonTypeName(ManifestType.GoogleCloudFunctionDefinition)
@FieldDefaults(level = AccessLevel.PRIVATE)
@SimpleVisitorHelper(helperClass = GoogleCloudFunctionDefinitionManifestVisitorHelper.class)
@TypeAlias("googleCloudFunctionDefinitionManifest")
@RecasterAlias("io.harness.cdng.manifest.yaml.kinds.GoogleCloudFunctionDefinitionManifest")
public class GoogleCloudFunctionDefinitionManifest implements ManifestAttributes, Visitable {
  ...
  public String getKind() {
    return ManifestType.GoogleCloudFunctionDefinition;
  }
  ...
  public ManifestAttributeStepParameters getManifestAttributeStepParameters() {
    return new GoogleCloudFunctionDefinitionManifestStepParameters(
  ...
  public ManifestAttributes applyOverrides(ManifestAttributes overrideConfig) {
    GoogleCloudFunctionDefinitionManifest googleCloudFunctionDefinitionManifest =
        (GoogleCloudFunctionDefinitionManifest) overrideConfig;
    GoogleCloudFunctionDefinitionManifest resultantManifest = this;
    if (googleCloudFunctionDefinitionManifest.getStore() != null
        && googleCloudFunctionDefinitionManifest.getStore().getValue() != null) {
      resultantManifest = resultantManifest.withStore(ParameterField.createValueField(
          store.getValue().applyOverrides(googleCloudFunctionDefinitionManifest.getStore().getValue())));
    }
    return resultantManifest;
  }

  @Value
  public static class GoogleCloudFunctionDefinitionManifestStepParameters implements ManifestAttributeStepParameters {
    String identifier;
