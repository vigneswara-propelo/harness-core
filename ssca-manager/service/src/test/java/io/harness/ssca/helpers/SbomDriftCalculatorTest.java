...
public class SbomDriftCalculatorTest extends SSCAManagerTestBase {
  ...
  public void testFindComponentDrifts() {
    ...
    assertThat(aggregation.toString())
        .isEqualTo(
            "{ \"aggregate\" : \"__collection__\", \"pipeline\" : [{ \"$facet\" : { \"baseComponentsSet\" : [{ \"$match\" : { \"orchestrationid\" : \"base\"}}, { \"$project\" : { \"packagename\" : 1, \"packageversion\" : 1, \"packageoriginatorname\" : 1, \"packagemanager\" : 1, \"packagelicense\" : 1, \"purl\" : 1, \"_id\" : 0}}], \"componentsSet\" : [{ \"$match\" : { \"orchestrationid\" : \"tag\"}}, { \"$project\" : { \"packagename\" : 1, \"packageversion\" : 1, \"packageoriginatorname\" : 1, \"packagemanager\" : 1, \"packagelicense\" : 1, \"purl\" : 1, \"_id\" : 0}}]}}, { \"$project\" : { \"deletedOrModifiedSet\" : { \"$setDifference\" : [\"$baseComponentsSet\", \"$componentsSet\"]}, \"addedOrModifiedSet\" : { \"$setDifference\" : [\"$componentsSet\", \"$baseComponentsSet\"]}}}]}");
