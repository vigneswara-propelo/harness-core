...
chmod +x ssca-manager/build/build_jar.sh
chmod +x ssca-manager/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD ssca-manager/build.properties
ssca-manager/build/build_jar.sh
ssca-manager/build/build_dist.sh || true
