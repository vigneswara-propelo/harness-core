...
public abstract class AbstractDataFetcherTestBase extends WingsBaseTest {
  ...
  public static final String QUERY1 =
      "SELECT PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY SUM_VALUE) AS CNT, T_SEQ_DATETIME AS GRP_BY_TIME FROM HARNESS_TIME_BUCKET_LIST(1234437555,1234455555,'hours') TB LEFT JOIN (SELECT REPORTEDAT, SUM(INSTANCECOUNT) AS SUM_VALUE FROM INSTANCE_STATS WHERE  REPORTEDAT  >= timestamp '2009-02-12T11:19:15.233Z' AND REPORTEDAT  < timestamp '2009-02-12T16:19:15.233Z' AND ACCOUNTID = 'ACCOUNT1_ID' GROUP BY REPORTEDAT) AS INSTANCE_STATS ON TB.T_SEQ_DATETIME = DATE_TRUNC('hour', INSTANCE_STATS.REPORTEDAT) GROUP BY GRP_BY_TIME ORDER BY GRP_BY_TIME";
  public static final String QUERY2 =
      "SELECT PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY SUM_VALUE) AS CNT, T_SEQ_DATETIME AS GRP_BY_TIME, ENTITY_ID FROM HARNESS_TIME_BUCKET_LIST(1234437555,1234455555,'hours') TB LEFT JOIN (SELECT APPID AS ENTITY_ID, REPORTEDAT, SUM(INSTANCECOUNT) AS SUM_VALUE FROM INSTANCE_STATS WHERE  APPID  = 'APP1_ID_ACCOUNT1' AND  REPORTEDAT  >= timestamp '2009-02-12T11:19:15.233Z' AND REPORTEDAT  < timestamp '2009-02-12T16:19:15.233Z' AND ACCOUNTID = 'ACCOUNT1_ID' GROUP BY ENTITY_ID, REPORTEDAT) AS INSTANCE_STATS ON TB.T_SEQ_DATETIME = DATE_TRUNC('hour', INSTANCE_STATS.REPORTEDAT) GROUP BY ENTITY_ID, GRP_BY_TIME ORDER BY GRP_BY_TIME";
  public static final String QUERY3 =
      "SELECT PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY SUM_VALUE) AS CNT, T_SEQ_DATETIME AS GRP_BY_TIME, ENTITY_ID FROM HARNESS_TIME_BUCKET_LIST(1234437555,1234455555,'days') TB LEFT JOIN (SELECT SERVICEID AS ENTITY_ID, REPORTEDAT, SUM(INSTANCECOUNT) AS SUM_VALUE FROM INSTANCE_STATS WHERE  SERVICEID  IN ('SERVICE1_ID_APP1_ACCOUNT1','SERVICE2_ID_APP1_ACCOUNT1') AND  REPORTEDAT  >= timestamp '2009-02-12T11:19:15.233Z' AND REPORTEDAT  < timestamp '2009-02-12T16:19:15.233Z' AND ACCOUNTID = 'ACCOUNT1_ID' GROUP BY ENTITY_ID, REPORTEDAT) AS INSTANCE_STATS ON TB.T_SEQ_DATETIME = DATE_TRUNC('day', INSTANCE_STATS.REPORTEDAT) GROUP BY ENTITY_ID, GRP_BY_TIME ORDER BY GRP_BY_TIME";
  public static final String QUERY4 =
      "SELECT PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY SUM_VALUE) AS CNT, T_SEQ_DATETIME AS GRP_BY_TIME, ENTITY_ID FROM HARNESS_TIME_BUCKET_LIST(1234437555,1234455555,'days') TB LEFT JOIN (SELECT CLOUDPROVIDERID AS ENTITY_ID, REPORTEDAT, SUM(INSTANCECOUNT) AS SUM_VALUE FROM INSTANCE_STATS WHERE  CLOUDPROVIDERID  IN ('CLOUD_PROVIDER1_ID_ACCOUNT1','CLOUD_PROVIDER2_ID_ACCOUNT1') AND  REPORTEDAT  >= timestamp '2009-02-12T11:19:15.233Z' AND REPORTEDAT  < timestamp '2009-02-12T16:19:15.233Z' AND ACCOUNTID = 'ACCOUNT1_ID' GROUP BY ENTITY_ID, REPORTEDAT) AS INSTANCE_STATS ON TB.T_SEQ_DATETIME = DATE_TRUNC('day', INSTANCE_STATS.REPORTEDAT) GROUP BY ENTITY_ID, GRP_BY_TIME ORDER BY GRP_BY_TIME";
  public static final String QUERY5 =
      "SELECT PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY SUM_VALUE) AS CNT, T_SEQ_DATETIME AS GRP_BY_TIME, ENTITY_ID FROM HARNESS_TIME_BUCKET_LIST(1234437555,1234455555,'days') TB LEFT JOIN (SELECT ENVID AS ENTITY_ID, REPORTEDAT, SUM(INSTANCECOUNT) AS SUM_VALUE FROM INSTANCE_STATS WHERE  ENVID  = 'ENV1_ID_APP1_ACCOUNT1' AND  REPORTEDAT  >= timestamp '2009-02-12T11:19:15.233Z' AND REPORTEDAT  < timestamp '2009-02-12T16:19:15.233Z' AND ACCOUNTID = 'ACCOUNT1_ID' GROUP BY ENTITY_ID, REPORTEDAT) AS INSTANCE_STATS ON TB.T_SEQ_DATETIME = DATE_TRUNC('day', INSTANCE_STATS.REPORTEDAT) GROUP BY ENTITY_ID, GRP_BY_TIME ORDER BY GRP_BY_TIME";
  public static final String QUERY6 =
      "SELECT PERCENTILE_DISC(0.50) WITHIN GROUP (ORDER BY SUM_VALUE) AS CNT, T_SEQ_DATETIME AS GRP_BY_TIME, ENTITY_ID FROM HARNESS_TIME_BUCKET_LIST(1234437555,1234455555,'days') TB LEFT JOIN (SELECT APPID AS ENTITY_ID, REPORTEDAT, SUM(INSTANCECOUNT) AS SUM_VALUE FROM INSTANCE_STATS WHERE  ENVID  IN ('ENV1_ID_APP1_ACCOUNT1','ENV3_ID_APP2_ACCOUNT1') AND  REPORTEDAT  >= timestamp '2009-02-12T11:19:15.233Z' AND REPORTEDAT  < timestamp '2009-02-12T16:19:15.233Z' AND ACCOUNTID = 'ACCOUNT1_ID' GROUP BY ENTITY_ID, REPORTEDAT) AS INSTANCE_STATS ON TB.T_SEQ_DATETIME = DATE_TRUNC('day', INSTANCE_STATS.REPORTEDAT) GROUP BY ENTITY_ID, GRP_BY_TIME ORDER BY GRP_BY_TIME";
