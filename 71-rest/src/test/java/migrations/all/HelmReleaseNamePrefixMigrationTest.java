...
public class HelmReleaseNamePrefixMigrationTest extends WingsBaseTest {
  ...
  @InjectMocks @Inject private HelmReleaseNamePrefixMigration helmReleaseNamePrefixMigration;
  ...
  public void testMigrationOfWorkflowsWithNoHelmReleaseNamePrefix() {
    ...
    assertThat(graphNode.getProperties().get(HELM_RELEASE_NAME_PREFIX_KEY))
        .isEqualTo(HELM_RELEASE_NAME_PREFIX_DEFAULT_VALUE);
  }

  @Test
  public void testMigrationOfWorkflowsWithHelmReleaseNamePrefix() {
    Map<String, Object> properties = new HashMap<>();
    ...
    assertThat(graphNode.getProperties()).containsKeys(HELM_RELEASE_NAME_PREFIX_KEY);
    assertThat(graphNode.getProperties().get(HELM_RELEASE_NAME_PREFIX_KEY)).isEqualTo("abc");
  }
  @Test
