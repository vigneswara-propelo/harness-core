...
public class AzureVMSSSetupStateTest extends WingsBaseTest {
  ...
  public void testExecute() {
    ...
    doReturn(activity).when(azureVMSSStateHelper).buildActivity(any(), any(), any(), any(), anyString());
    doReturn(activity).when(azureVMSSStateHelper).saveActivity(any(), anyString());
    ...
    doReturn(activity).when(azureVMSSStateHelper).saveActivity(activity, appId);
