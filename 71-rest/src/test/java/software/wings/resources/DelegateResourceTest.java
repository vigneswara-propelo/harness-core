...
public class DelegateResourceTest extends CategoryTest {
  ...
  public static final ResourceTestRule RESOURCES =
      ResourceTestRule.builder()
          .addResource(new DelegateResource(DELEGATE_SERVICE, DELEGATE_SCOPE_SERVICE, DOWNLOAD_TOKEN_SERVICE,
              accountService, wingsPersistence, delegateRequestRateLimiter, subdomainUrlHelper, delegateConnectionDao))
  ...
  public void shouldDownloadDelegate() throws Exception {
    ...
    when(DELEGATE_SERVICE.downloadScripts(anyString(), anyString(), anyString(), anyString(), anyString()))
        .thenReturn(file);
