...
import static software.wings.common.TemplateConstants.POWER_SHELL_IIS_V5_INSTALL_PATH;
...
public class IISInstallCommandV4Migration implements SeedDataMigration {
  private static final Logger logger = getLogger(IISInstallCommandV4Migration.class);
  ...
  public void migrate() {
    try {
      logger.info("Migrating Install Command for IIS to V5");
      updateExistingInstallCommand(POWER_SHELL_IIS_V5_INSTALL_PATH, "iis");

      logger.info("Migrating Install Website Command for IIS to V4");
      updateExistingInstallCommand(POWER_SHELL_IIS_WEBSITE_V4_INSTALL_PATH, "iiswebsite");

      logger.info("Migrating Install App Command for IIS to V4");
      updateExistingInstallCommand(POWER_SHELL_IIS_APP_V4_INSTALL_PATH, "iisapp");
