    ...
    return Plan.builder()
        .node(PlanNode.builder()
                  ...
                  .adviserObtainment(AdviserObtainment.builder()
                                         .type(AdviserType.newBuilder().setType("HTTP_RESPONSE_CODE_SWITCH").build())
  ...
  public Plan provideHttpRetryIgnorePlan() {
    ...
    return Plan.builder()
        ...
        .node(PlanNode.builder()
                  ...
                  .adviserObtainment(
                      AdviserObtainment.builder()
                          .type(AdviserType.newBuilder().setType(OrchestrationAdviserTypes.RETRY.name()).build())
    ...
    return Plan.builder()
        ...
        .node(
            PlanNode.builder()
                ...
                .adviserObtainment(AdviserObtainment.builder()
                                       .type(OnSuccessAdviser.ADVISER_TYPE)
                                       .parameters(OnSuccessAdviserParameters.builder().nextNodeId(httpNode3Id).build())
                                       .build())
                .facilitatorObtainment(FacilitatorObtainment.builder()
                                           .type(FacilitatorType.builder().type(FacilitatorType.TASK).build())
                                           .build())
