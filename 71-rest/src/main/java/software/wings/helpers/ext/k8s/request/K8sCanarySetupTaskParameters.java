...
public class K8sCanarySetupTaskParameters extends K8sTaskParameters {
  private K8sDelegateManifestConfig k8sDelegateManifestConfig;
  @Expression private List<String> valuesYamlList;

  @Builder
  public K8sCanarySetupTaskParameters(String accountId, String appId, String commandName, String activityId,
