...
public interface ImportedTemplateService {
  ...
  Template getTemplateByCommandId(String commandIs, String commandStoreId, String accountId);
  ...
  ImportedCommandTemplate get(String commandId, String commandStoreId, String accountId);
