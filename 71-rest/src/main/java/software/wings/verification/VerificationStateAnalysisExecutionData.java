...
public class VerificationStateAnalysisExecutionData extends StateExecutionData {
  ...
  public Map<String, ExecutionDataValue> getExecutionDetails() {
    ...
    if (MLAnalysisType.TIME_SERIES.equals(mlAnalysisType)) {
      Set<String> crypticHostnames = Sets.newHashSet("testNode", "controlNode", "controlNode-1", "controlNode-2",
          "controlNode-3", "controlNode-4", "controlNode-5", "controlNode-6", "controlNode-7", "null");
