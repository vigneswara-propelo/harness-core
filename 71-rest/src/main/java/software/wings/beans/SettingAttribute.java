...
public class SettingAttribute extends Base implements NameAccess, PersistentRegularIterable {
  ...
  public static final class SettingAttributeKeys {
    ...
    public static final String isCEEnabled = SettingAttributeKeys.value + ".ccmConfig"
        + ".cloudCostEnabled";
    public static final String isBillingReportEnabled = SettingAttributeKeys.value + ".ccmConfig"
        + ".billingReportConfig"
        + ".isBillingReportEnabled";
  }
}
