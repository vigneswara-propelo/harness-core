...
public enum TaskType {
  ...
  CE_DELEGATE_VALIDATION(TaskGroup.CONTAINER, ServiceImplDelegateTask.class, ContainerValidation.class),
  ...
  K8S_COMMAND_TASK_NG(TaskGroup.K8S_NG, K8sTaskNG.class, AlwaysTrueValidation.class),
