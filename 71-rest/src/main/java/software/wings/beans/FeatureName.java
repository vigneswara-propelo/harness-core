...
public enum FeatureName {
  ...
  */
  ...
  USE_SCOPED_TO_ACCOUNT_SECRETS,
  SERVICENOW_MULTIPLE_CONDITIONS(Scope.GLOBAL),
  CV_NEW_INSTANCE_API,
  MULTIPLE_HELM_VALUES_OVERRIDE,
  GCB_CI_SYSTEM,
  DISABLE_WINRM_COMMAND_ENCODING,
  ENABLE_CDNG_RESOURCES(Scope.GLOBAL);
