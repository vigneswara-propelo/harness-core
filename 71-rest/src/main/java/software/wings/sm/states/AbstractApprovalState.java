...
public abstract class AbstractApprovalState extends State {
  ...
  public AbstractApprovalState(String name, String stateType) {
    super(name, stateType);
  }

  public abstract ExecutionResponse execute(ExecutionContext context);

  public abstract ExecutionResponse handleAsyncResponse(ExecutionContext context, Map<String, ResponseData> response);
  ...
  public NotificationMessageType handleAbortEventAbstract(ExecutionContext context) {
