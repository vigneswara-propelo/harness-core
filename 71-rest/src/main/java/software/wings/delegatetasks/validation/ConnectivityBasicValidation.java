...
public class ConnectivityBasicValidation extends AbstractDelegateValidateTask {
  ...
  public ConnectivityBasicValidation(String delegateId, DelegateTaskPackage delegateTaskPackage,
  ...
  private List<DelegateConnectionResult> getSocketConnectivity(String hostName, int port, String criteria) {
    ...
    try (Socket socket = new Socket()) {
      ...
      log.error("Exception: [{}] while validating basic socket connectivity", ex.getMessage(), ex);
      valid = false;
    }
