...
public interface ScmClient {
  ...
  GitFileContentResponse getFileContent(GitFileRequestV2 gitFileRequestV2);

  GitFileContentBatchResponse getBatchFileContent(GitFileBatchRequest gitFileBatchRequest);
}
