...
@OwnedBy(CDC)
@Slf4j
public class PmsSdkCoreRegistryModule extends AbstractModule {
  private static PmsSdkCoreRegistryModule instance;

  public static synchronized PmsSdkCoreRegistryModule getInstance() {
    if (instance == null) {
      instance = new PmsSdkCoreRegistryModule();
    }
    return instance;
  }
