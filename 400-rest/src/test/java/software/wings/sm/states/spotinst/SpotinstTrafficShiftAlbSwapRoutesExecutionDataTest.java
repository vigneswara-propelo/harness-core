...
@OwnedBy(CDP)
public class SpotinstTrafficShiftAlbSwapRoutesExecutionDataTest extends CategoryTest {
  @Test
  ...
  public void testData() {
    ...
    assertThat(executionSummary.containsKey("New Elastigroup Weight")).isTrue();
  }
}
