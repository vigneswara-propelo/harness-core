...
@OwnedBy(CDC)
public class BambooArtifactStreamYamlHandlerTest extends YamlHandlerTestBase {
  @InjectMocks @Inject private BambooArtifactStreamYamlHandler yamlHandler;
  ...
  public void toYaml() {
    BambooArtifactStream artifactStream = BambooArtifactStream.builder()
  ...
  public void upsertFromYaml() {
    ...
    final ArgumentCaptor<BambooArtifactStream> captor = ArgumentCaptor.forClass(BambooArtifactStream.class);
    yamlHandler.upsertFromYaml(changeContext, asList(changeContext));
    verify(artifactStreamService).createWithBinding(anyString(), captor.capture(), anyBoolean());
    final BambooArtifactStream artifactStream = captor.getValue();
    ...
    assertThat(artifactStream.getArtifactStreamType()).isEqualTo(BAMBOO.name());
  }
