...
public class GeneralEventConsumerCg extends AbstractBaseConsumerCg {
  @Inject
  public GeneralEventConsumerCg(@Named(CG_GENERAL_EVENT) Consumer redisConsumer,
      @Named(CG_GENERAL_EVENT) MessageListener messageListener, QueueController queueController,
