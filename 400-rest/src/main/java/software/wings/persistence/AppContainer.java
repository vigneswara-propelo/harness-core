...
package software.wings.persistence;
...
public class AppContainer extends BaseFile {
  ...
  public software.wings.beans.AppContainer toDTO() {
    software.wings.beans.AppContainer appContainer = new software.wings.beans.AppContainer();
    appContainer.setName(getName());
    appContainer.setFileUuid(getFileUuid());
    appContainer.setFileName(getFileName());
    appContainer.setMimeType(getMimeType());
    appContainer.setSize(getSize());
    appContainer.setChecksumType(getChecksumType());
    appContainer.setChecksum(getChecksum());
    appContainer.setStandard(standard);
    appContainer.setDescription(description);
    appContainer.setStandardUpload(standardUpload);
    appContainer.setFamily(family);
    appContainer.setStackRootDirectory(stackRootDirectory);
    appContainer.setFileType(fileType);
    appContainer.setUuid(getUuid());
    appContainer.setAppId(appId);
    appContainer.setCreatedBy(getCreatedBy());
    appContainer.setCreatedAt(getCreatedAt());
    appContainer.setLastUpdatedBy(getLastUpdatedBy());
    appContainer.setLastUpdatedAt(getLastUpdatedAt());
    appContainer.setSystemCreated(systemCreated);
    appContainer.setAccountId(accountId);
    appContainer.setHardened(hardened);
    appContainer.setVersion(version);
