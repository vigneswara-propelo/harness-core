...
public class IISArtifactCommands implements ArtifactCommands {
  @Override
        ...
        .withCommandUnits(
            asList(new CommandUnit[] {aDownloadArtifactCommandUnit()
                ...
                anExecCommandUnit()
                    ...
                    .build(),
                anExecCommandUnit()
                    .withName(PowerShellScriptsLoader.PsScript.CreateIISAppPool.getDisplayName())
                    .withScriptType(POWERSHELL)
                    .withCommandString(psScriptMap.get(PowerShellScriptsLoader.PsScript.CreateIISAppPool))
                    .build(),
                anExecCommandUnit()
                    .withName(PowerShellScriptsLoader.PsScript.CreateIISWebsite.getDisplayName())
                    .withScriptType(POWERSHELL)
                    .withCommandString(psScriptMap.get(PowerShellScriptsLoader.PsScript.CreateIISWebsite))
                    .build()}))
        .build();
  }
}
