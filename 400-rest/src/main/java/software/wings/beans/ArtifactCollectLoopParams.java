...
import static software.wings.beans.CollectionEntityType.ARTIFACT;
...
@Value
@Builder
public class ArtifactCollectLoopParams implements LoopParams {
  ...
  public State getEnvStateInstanceFromParams(WorkflowService workflowService, String appId) {
    ...
    properties.put(ArtifactCollectionStateKeys.artifactStreamId, artifactStreamId);
    properties.put(ArtifactCollectionStateKeys.buildNo, buildNo);
    properties.put(ArtifactCollectionStateKeys.regex, false);
    properties.put(ArtifactCollectionStateKeys.sourceType, ARTIFACT);
