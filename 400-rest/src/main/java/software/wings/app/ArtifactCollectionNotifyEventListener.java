...
@Singleton
public final class ArtifactCollectionNotifyEventListener extends NotifyEventListener {
  @Inject
  public ArtifactCollectionNotifyEventListener(
    ...
    super(QueueFactory.createQueueConsumer(injector, NotifyEvent.class, ofSeconds(5),
        asList(asList(versionInfoManager.getVersionInfo().getVersion()), asList(ARTIFACT_COLLECTION)), config));
  }
}
