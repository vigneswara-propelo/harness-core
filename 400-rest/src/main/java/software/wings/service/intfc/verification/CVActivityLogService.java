...
public interface CVActivityLogService {
  ...
  CVActivityLogger getLogger(String accountId, String cvConfigId, long dataCollectionMinute, String stateExecutionId);
  CVActivityLogger getLoggerByCVConfigId(String accountId, String cvConfigId, long dataCollectionMinute);
  CVActivityLogger getLoggerByStateExecutionId(String accountId, String stateExecutionId);
