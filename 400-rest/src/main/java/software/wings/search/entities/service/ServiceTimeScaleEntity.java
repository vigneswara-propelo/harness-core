...
public class ServiceTimeScaleEntity implements TimeScaleEntity<Service> {
  ...
  public String getMigrationClassName() {
    return migrateServicesToTimeScaleDB.getTimescaleDBClass();
  }
  ...
  public void savetoTimescale(Service entity) {
    migrateServicesToTimeScaleDB.saveToTimeScale(entity);
  }

  @Override
  public void deleteFromTimescale(String id) {
    migrateServicesToTimeScaleDB.deleteFromTimescale(id);
  }
}
