...
if [ ! -z "$NOT_MERGED" ]
then
    echo "ERROR: There are jira issues in iacm manager release branches that are not reflected in develop."
    exit 1
fi
...
export VERSION_FILE=310-iacm-manager/build.properties
