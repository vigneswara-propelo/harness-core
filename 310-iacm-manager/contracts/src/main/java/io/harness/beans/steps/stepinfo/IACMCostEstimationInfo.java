...
@TypeAlias("iacmCostEstimationInfo")
@OwnedBy(IACM)
@RecasterAlias("io.harness.beans.steps.stepinfo.IACMCostEstimationInfo")
@EqualsAndHashCode(callSuper = true)
public class IACMCostEstimationInfo extends IACMStepInfo {
  ...
  public TypeInfo getNonYamlInfo() {
    return TypeInfo.builder().stepInfoType(CIStepInfoType.IACM_COST_ESTIMATION).build();
  }
  ...
  public IACMCostEstimationInfo(String identifier, String name, Integer retry,
