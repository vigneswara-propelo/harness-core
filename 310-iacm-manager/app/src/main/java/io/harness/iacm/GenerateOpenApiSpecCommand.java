...
@Slf4j
public class GenerateOpenApiSpecCommand extends ConfiguredCommand<IACMManagerConfiguration> {
  ...
  @Override
  protected void run(Bootstrap<IACMManagerConfiguration> bootstrap, Namespace namespace,
      IACMManagerConfiguration configuration) throws Exception {
