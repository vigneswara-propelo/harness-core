...
import io.harness.iacm.beans.steps.nodes.IACMTerraformPlanStepNode;
...
public class IACMTerraformPlanStepVariableCreator extends GenericStepVariableCreator<IACMTerraformPlanStepNode> {
  @Override
