...
import io.harness.app.IACMManagerConfiguration;
import io.harness.app.IACMManagerServiceModule;
...
import io.harness.ci.registrars.IACMExecutionRegistrar;
...
@Slf4j
@OwnedBy(IACM)
public class IACMManagerRule implements MethodRule, InjectorRuleMixin, MongoRuleMixin {
  ClosingFactory closingFactory;
  public IACMManagerRule(ClosingFactory closingFactory) {
  ...
  public List<Module> modules(List<Annotation> annotations) {
    ...
    IACMManagerConfiguration configuration =
        IACMManagerConfiguration.builder()
            ...
            .logServiceConfig(io.harness.ci.beans.entities.LogServiceConfig.builder()
                                  .internalUrl("http://localhost-inc:8079")
                                  .baseUrl("http://localhost-inc:8079")
                                  .globalToken("global-token")
                                  .build())
            .tiServiceConfig(io.harness.ci.beans.entities.TIServiceConfig.builder()
  ...
  private PmsSdkConfiguration getPmsSdkConfiguration() {
    return PmsSdkConfiguration.builder()
        ...
        .engineSteps(IACMExecutionRegistrar.getEngineSteps())
