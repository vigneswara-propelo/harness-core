...
chmod +x 310-iacm-manager/build/build_jar.sh
chmod +x 310-iacm-manager/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD 310-iacm-manager/build.properties
310-iacm-manager/build/build_jar.sh
310-iacm-manager/build/build_dist.sh || true
