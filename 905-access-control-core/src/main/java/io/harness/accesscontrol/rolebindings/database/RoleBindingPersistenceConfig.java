...
@Configuration
@EnableMongoRepositories(basePackages = {"io.harness.accesscontrol.rolebindings.database"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class))
public class RoleBindingPersistenceConfig extends AbstractMongoConfiguration {
  private final MongoConfig mongoBackendConfiguration;

  @Inject
  public RoleBindingPersistenceConfig(Injector injector) {
