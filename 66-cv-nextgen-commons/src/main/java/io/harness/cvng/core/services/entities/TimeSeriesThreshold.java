...
public class TimeSeriesThreshold implements PersistentEntity, UuidAware, CreatedAtAware, UpdatedAtAware, AccountAccess {
  ...
  @NotNull @Indexed private String projectIdentifier;
  @NotNull @Indexed private DataSourceType dataSourceType;
  @NotNull @Indexed private String metricPackIdentifier;
