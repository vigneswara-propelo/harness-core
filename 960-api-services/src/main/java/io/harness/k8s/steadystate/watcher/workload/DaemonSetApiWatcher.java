...
public class DaemonSetApiWatcher implements WorkloadWatcher {
  ...
  private static final Type v1DaemonSetType = new TypeToken<Watch.Response<V1DaemonSet>>() {}.getType();
  ...
  private boolean watchDaemonSetWithRetry(ApiClient apiClient, KubernetesResourceId workload,
    ...
    return kubernetesContainerService.<V1DaemonSet>watchRetriesWrapper(workloadDetails, callSupplier, event -> {
