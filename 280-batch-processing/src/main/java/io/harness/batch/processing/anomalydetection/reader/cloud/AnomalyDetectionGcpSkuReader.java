...
@Slf4j
public class AnomalyDetectionGcpSkuReader extends AnomalyDetectionCloudReader {
  @Override
  public void beforeStep(StepExecution stepExecution) {
    ...
    timeSeriesMetaData = TimeSeriesMetaData.builder()
                             ...
                             .testEnd(endTime)
                             .entityType(EntityType.GCP_SKU_ID)
    ...
    CloudBillingGroupBy skuIdGroupBy = new CloudBillingGroupBy();
    skuIdGroupBy.setEntityGroupBy(CloudEntityGroupBy.skuId);
    groupByList.add(skuIdGroupBy);

    CloudBillingGroupBy skuDescriptionGroupBy = new CloudBillingGroupBy();
    skuDescriptionGroupBy.setEntityGroupBy(CloudEntityGroupBy.sku);
    groupByList.add(skuDescriptionGroupBy);
    ...
    sortCriteriaList.add(
        CloudBillingSortCriteria.builder().sortType(CloudSortType.gcpSkuId).sortOrder(QLSortOrder.ASCENDING).build());

    sortCriteriaList.add(CloudBillingSortCriteria.builder()
                             .sortType(CloudSortType.gcpSkuDescription)
                             .sortOrder(QLSortOrder.ASCENDING)
                             .build());
