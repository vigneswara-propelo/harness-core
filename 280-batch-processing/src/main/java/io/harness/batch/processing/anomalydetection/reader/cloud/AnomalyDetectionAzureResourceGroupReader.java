...
public class AnomalyDetectionAzureResourceGroupReader extends AnomalyDetectionCloudReaderNG {
  @Override
  public void beforeStep(StepExecution stepExecution) {
    ...
    timeSeriesMetaData = TimeSeriesMetaData.builder()
                             ...
                             .testEnd(endTime)
                             .entityType(EntityType.AZURE_RESOURCE_GROUP)
    ...
    // groupby
    CloudBillingGroupBy subscriptionGroupBy = new CloudBillingGroupBy();
