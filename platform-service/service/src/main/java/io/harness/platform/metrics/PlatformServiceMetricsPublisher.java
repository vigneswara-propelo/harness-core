...
package io.harness.platform.metrics;
...
@Slf4j
public class PlatformServiceMetricsPublisher implements MetricsPublisher {
  ...
  private static final String SERVICE_NAME = "platform-service";
  ...
  private void recordMeter(String metricName, Meter meter) {
    try (PlatformServiceMetricsContext ignore =
             new PlatformServiceMetricsContext(NAMESPACE, CONTAINER_NAME, SERVICE_NAME)) {
