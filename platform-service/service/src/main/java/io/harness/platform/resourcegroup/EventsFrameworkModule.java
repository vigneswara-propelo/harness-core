...
public class EventsFrameworkModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    if (redisConfig.getRedisUrl().equals("dummyRedisUrl")) {
      bind(Consumer.class)
          .annotatedWith(Names.named(EventsFrameworkConstants.ENTITY_CRUD + RESOUCE_GROUP_SERVICE))
          .toInstance(
      ...
      bind(Consumer.class)
          .annotatedWith(Names.named(EventsFrameworkConstants.ENTITY_CRUD + RESOUCE_GROUP_SERVICE))
          .toInstance(RedisConsumer.of(EventsFrameworkConstants.ENTITY_CRUD, RESOUCE_GROUP_SERVICE.getServiceId(),
