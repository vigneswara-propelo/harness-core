...
public class GenerateOpenApiSpecCommandTest {
  ...
  public void setUp() throws MalformedURLException {
    ...
    final Bootstrap<PlatformConfiguration> bootstrap = new Bootstrap<>(new PlatformApplication());
  ...
  @Owner(developers = ASHISHSANODIA)
  @Category(UnitTests.class)
  public void doNotGeneratesOpenApiSpecIfProvidedMoreThanExpectedParameter() throws Exception {
    final Optional<Throwable> success = cli.run(GENERATE_OPENAPI_SPEC, TEST_OPENAPI_JSON, "extra-param");
    String openApiContent = openApiOutputStream.toString(UTF_8.name());
