...
@Getter
@NoArgsConstructor
public class StreamingDestinationDeleteEvent implements Event {
  public static final String STREAMING_DESTINATION_DELETE_EVENT = "StreamingDestinationDeleted";
  String accountIdentifier;
  StreamingDestinationDTO streamingDestination;

  public StreamingDestinationDeleteEvent(String accountIdentifier, StreamingDestinationDTO streamingDestination) {
  ...
  public String getEventType() {
    return STREAMING_DESTINATION_DELETE_EVENT;
  }
}
