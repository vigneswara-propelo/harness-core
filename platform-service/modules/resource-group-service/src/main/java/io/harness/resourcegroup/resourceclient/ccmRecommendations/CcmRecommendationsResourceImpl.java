...
package io.harness.resourcegroup.resourceclient.ccmRecommendations;
...
@Slf4j
@OwnedBy(CE)
public class CcmRecommendationsResourceImpl implements Resource {
  @Override
  public String getType() {
    return "CCM_RECOMMENDATIONS";
  }
