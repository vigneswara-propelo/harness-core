...
package io.harness.resourcegroup.resourceclient.idp;
...
@Slf4j
@OwnedBy(IDP)
public class IdpAdvancedConfigurationResourceImpl implements Resource {
  public static final String IDP_ADVANCED_CONFIGURATION = "IDP_ADVANCED_CONFIGURATION";

  @Override
  public String getType() {
    return IDP_ADVANCED_CONFIGURATION;
  }
  ...
  public Map<ScopeLevel, EnumSet<ValidatorType>> getSelectorKind() {
    return Map.of(ScopeLevel.ACCOUNT, EnumSet.of(BY_RESOURCE_TYPE, BY_RESOURCE_TYPE_INCLUDING_CHILD_SCOPES));
  }
