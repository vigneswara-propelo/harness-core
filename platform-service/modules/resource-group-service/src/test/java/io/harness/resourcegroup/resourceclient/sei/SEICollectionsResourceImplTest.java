...
public class SEICollectionsResourceImplTest {
  @Test
  @Category(UnitTests.class)
  public void testGetResourceInfoFromEvent() {
    SEICollectionsResourceImpl seiCollectionsResource = new SEICollectionsResourceImpl();
    ...
    ResourceInfo resourceInfo = seiCollectionsResource.getResourceInfoFromEvent(consumerMessage);
    ...
    Assertions.assertThat(resourceInfo.getResourceType()).isEqualTo("SEI_COLLECTIONS");
  }
}
