...
@OwnedBy(CDC)
public class ServiceNowCreateStep extends TaskExecutableWithRollbackAndRbac<ServiceNowTaskNGResponse> {
  ...
  public TaskRequest obtainTaskAfterRbac(
    ...
    ServiceNowTaskNGParametersBuilder paramsBuilder =
        ServiceNowTaskNGParameters.builder().action(ServiceNowActionNG.CREATE_TICKET);
    return null;
  }
