...
@OwnedBy(PL)
public class SecretManagerTemplateYamlConversionHandler implements YamlConversionHandler {
  @Override
  ...
  public TemplateYamlConversionData getAdditionalFieldsToAdd(
    ...
    return TemplateYamlConversionData.builder().templateYamlConversionRecordList(Collections.emptyList()).build();
  }
}
