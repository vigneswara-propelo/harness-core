...
public class HealthResource {
  ...
  @Timed
  @ExceptionMetered
  @ApiOperation(value = "get health for STOManager service", nickname = "getSTOManagerHealthStatus")
  ...
  @Timed
  @ExceptionMetered
  @ApiOperation(value = "get liveness status for STOManager service", nickname = "getSTOManagerLivenessStatus")
