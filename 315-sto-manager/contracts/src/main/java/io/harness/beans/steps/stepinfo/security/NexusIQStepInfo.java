...
@TypeAlias("nexusIQStepInfo")
@OwnedBy(STO)
@RecasterAlias("io.harness.beans.steps.stepinfo.security.NexusIQStepInfo")
public class NexusIQStepInfo extends STOGenericStepInfo {
  @NotNull
