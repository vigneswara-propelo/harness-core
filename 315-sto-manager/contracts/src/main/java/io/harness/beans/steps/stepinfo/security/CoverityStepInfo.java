...
@TypeAlias("coverityStepInfo")
@OwnedBy(STO)
@RecasterAlias("io.harness.beans.steps.stepinfo.security.CoverityStepInfo")
public class CoverityStepInfo extends STOGenericStepInfo {
  @NotNull
