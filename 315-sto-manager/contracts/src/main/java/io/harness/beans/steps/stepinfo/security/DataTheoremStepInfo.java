...
@TypeAlias("dataTheoremStepInfo")
@OwnedBy(STO)
@RecasterAlias("io.harness.beans.steps.stepinfo.security.DataTheoremStepInfo")
public class DataTheoremStepInfo extends STOGenericStepInfo {
  @NotNull
