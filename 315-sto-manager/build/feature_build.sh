...
chmod +x 315-sto-manager/build/build_jar.sh
chmod +x 315-sto-manager/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD 315-sto-manager/build.properties
315-sto-manager/build/build_jar.sh
315-sto-manager/build/build_dist.sh || true
