...
public class NextGenCoreTestRule implements InjectorRuleMixin, MethodRule, MongoRuleMixin {
  ClosingFactory closingFactory;

  public NextGenCoreTestRule(ClosingFactory closingFactory) {
