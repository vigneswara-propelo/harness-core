...
@Singleton
public class NextGenPrivilegedClientFactory
    extends AbstractHttpClientFactory implements Provider<NextGenPrivilegedClient> {
  private NGManagerServiceConfig ngManagerServiceConfig;
  private ClientMode clientMode;

  public NextGenPrivilegedClientFactory(
  ...
  @Override
  public NextGenPrivilegedClient get() {
    ...
    final Retrofit retrofit =
        new Retrofit.Builder()
            ...
            .build();
    return retrofit.create(NextGenPrivilegedClient.class);
  }
