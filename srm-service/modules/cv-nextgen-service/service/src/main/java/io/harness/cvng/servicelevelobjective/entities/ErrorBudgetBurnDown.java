...
@Data
@Builder
@FieldNameConstants(innerTypeName = "ErrorBudgetBurnDownKeys")
...
public class ErrorBudgetBurnDown
  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        .add(CompoundMongoIndex.builder()
                 ...
                 .unique(true)
                 .field(ErrorBudgetBurnDownKeys.accountId)
                 .field(ErrorBudgetBurnDownKeys.orgIdentifier)
                 .field(ErrorBudgetBurnDownKeys.projectIdentifier)
                 .field(ErrorBudgetBurnDownKeys.sloIdentifier)
