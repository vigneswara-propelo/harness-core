...
public interface TicketService {
  TicketResponseDto createTicketForFeedbackId(
      ProjectPathParams projectParams, String feedbackId, TicketRequestDto ticketRequestDto, String authToken);
  TicketResponseDto getTicketForFeedbackId(String feedbackId);
}
