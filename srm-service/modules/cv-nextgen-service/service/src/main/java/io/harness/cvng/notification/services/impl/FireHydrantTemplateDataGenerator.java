...
import static io.harness.cvng.notification.utils.NotificationRuleConstants.CHANNEL_ID;
...
public class FireHydrantTemplateDataGenerator
  ...
  public Map<String, String> getTemplateData(ProjectParams projectParams, Map<String, Object> entityDetails,
    ...
    templateDataMap.put(CHANNEL_ID, String.valueOf(entityDetails.get(CHANNEL_ID)));
