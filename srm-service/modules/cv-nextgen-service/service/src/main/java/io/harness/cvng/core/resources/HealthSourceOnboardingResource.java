...
public class HealthSourceOnboardingResource {
  ...
  @ExceptionMetered
  @ApiOperation(
      value = "Fetch possible values for healthSourceParams and healthSourceQueryParams", nickname = "getParamValues")
  public RestResponse<HealthSourceParamValuesResponse>
  getParamValues(@Valid @BeanParam ProjectPathParams projectPathParams,
      @NotNull @Valid @Body HealthSourceParamValuesRequest healthSourceParamValuesRequest) {
    ProjectParams projectParams = ProjectParams.builder()
                                      .accountIdentifier(projectPathParams.getAccountIdentifier())
                                      .orgIdentifier(projectPathParams.getOrgIdentifier())
                                      .projectIdentifier(projectPathParams.getProjectIdentifier())
                                      .build();
    return new RestResponse<>(
        healthSourceOnboardingService.fetchHealthSourceParamValues(healthSourceParamValuesRequest, projectParams));
  }
}