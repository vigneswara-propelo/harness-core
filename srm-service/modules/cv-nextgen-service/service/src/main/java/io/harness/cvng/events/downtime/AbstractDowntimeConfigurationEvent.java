...
@Getter
@NoArgsConstructor
public abstract class AbstractDowntimeConfigurationEvent implements Event {
  private String accountIdentifier;
  private String orgIdentifier;
  private String projectIdentifier;

  public enum DowntimeEventTypes {
    CREATE("DowntimeCreateEvent"),
    UPDATE("DowntimeUpdateEvent"),
    DELETE("DowntimeDeleteEvent");

    private final String displayName;

    DowntimeEventTypes(String displayName) {
