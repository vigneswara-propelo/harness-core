...
public interface NextGenHealthSourceHelper {
  DataCollectionRequest<? extends ConnectorConfigDTO> getDataCollectionRequest(
      HealthSourceRecordsRequest healthSourceRecordsRequest);
  default List<HealthSourceParamValue> fetchHealthSourceParamValues(
