...
public class DataCollectionDSLFactory {
  ...
  private static final String DATADOG_LOG_DATACOLLECTION_FILE = "datadog-log-fetch-data.datacollection";
  ...
  static {
    ...
    dataSourceTypeToDslScriptPathMap.put(DataSourceType.DATADOG_LOG, DATADOG_LOG_DATACOLLECTION_FILE);
