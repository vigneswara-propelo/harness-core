...
public class AzureLogsDataCollectionDSLTest extends HoverflyTestBase {
  ...
  private final String sampleDSLQuery = "let FindString = \"\";\n"
      + "ContainerLog \n"
  ...
  public void testExecute_AzureLogs_DSL_getSampleData() {
    ...
    AzureLogsSampleDataRequest azureLogsSampleDataRequest =
        AzureLogsSampleDataRequest.builder()
            .query(sampleDSLQuery)
            .from(startTime)
            .to(endTime)
