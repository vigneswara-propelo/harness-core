...
@Value
@JsonTypeName(NGVariableConstantsV1.BOOLEAN_TYPE)
@CodePulse(module = ProductModule.CDS, unitCoverageRequired = true, components = {HarnessModuleComponent.CDS_PIPELINE})
@OwnedBy(PIPELINE)
public class BooleanNGVariableV1 implements NGVariableV1 {
  NGVariableTypeV1 type = NGVariableTypeV1.BOOLEAN;
  boolean execution_input;
  ParameterField<Boolean> value;
  String desc;
  boolean required;
