...
chmod +x debezium-service/build/build_jar.sh
chmod +x debezium-service/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD debezium-service/build.properties
debezium-service/build/build_jar.sh
debezium-service/build/build_dist.sh || true
