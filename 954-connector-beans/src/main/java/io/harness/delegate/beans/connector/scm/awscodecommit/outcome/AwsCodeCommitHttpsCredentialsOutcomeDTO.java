...
public class AwsCodeCommitHttpsCredentialsOutcomeDTO implements AwsCodeCommitCredentialsOutcomeDTO {
  @NotNull AwsCodeCommitHttpsAuthType type;
  @JsonTypeInfo(
      use = JsonTypeInfo.Id.NAME, property = "type", include = JsonTypeInfo.As.EXTERNAL_PROPERTY, visible = true)
  @Valid
  @NotNull
  AwsCodeCommitHttpsCredentialsSpecDTO spec;

  @Builder
  public AwsCodeCommitHttpsCredentialsOutcomeDTO(
      AwsCodeCommitHttpsAuthType type, AwsCodeCommitHttpsCredentialsSpecDTO spec) {
    this.type = type;
    this.spec = spec;
  }
}
