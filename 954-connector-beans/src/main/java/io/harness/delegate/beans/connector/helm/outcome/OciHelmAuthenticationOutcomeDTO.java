...
public class OciHelmAuthenticationOutcomeDTO {
  @NotNull OciHelmAuthType type;

  @JsonTypeInfo(
      use = JsonTypeInfo.Id.NAME, property = "type", include = JsonTypeInfo.As.EXTERNAL_PROPERTY, visible = true)
  @Valid
  OciHelmAuthCredentialsDTO spec;

  @Builder
  public OciHelmAuthenticationOutcomeDTO(OciHelmAuthType type, OciHelmAuthCredentialsDTO spec) {
    this.type = type;
    this.spec = spec;
  }
}
