...
public class GitSSHAuthenticationOutcomeDTO extends GitAuthenticationOutcomeDTO {
  @ApiModelProperty(dataType = "string") @NotNull @SecretReference SecretRefData sshKeyRef;
}
