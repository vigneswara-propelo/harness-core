...
@Schema(
    name = "JiraUserNamePassword", description = "This entity contains the details of the Jira Username and Password")
public class JiraUserNamePasswordDTO implements JiraAuthCredentialsDTO {
  String username;
