...
// Source: github.com/wings-software/log-service/stream (interfaces: Stream)
...
func (m *MockStream) Create(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
...
func (m *MockStream) Delete(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
...
func (m *MockStream) Tail(arg0 context.Context, arg1 int64) (<-chan *stream.Line, <-chan error) {
	m.ctrl.T.Helper()
...
func (m *MockStream) Write(arg0 context.Context, arg1 int64, arg2 ...*stream.Line) error {
	m.ctrl.T.Helper()
