...
// ListBlobPrefix mocks base method
func (m *MockStore) ListBlobPrefix(ctx context.Context, prefix string, limit int) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListBlobPrefix", ctx, prefix, limit)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListBlobPrefix indicates an expected call of ListBlobPrefix
func (mr *MockStoreMockRecorder) ListBlobPrefix(ctx, prefix, limit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListBlobPrefix", reflect.TypeOf((*MockStore)(nil).ListBlobPrefix), ctx, prefix, limit)
}
