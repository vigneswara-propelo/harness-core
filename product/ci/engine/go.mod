...
replace github.com/wings-software/portal/16-expression-service/src/main/go => ../../../16-expression-service/src/main/go
...
require (
	...
	github.com/wings-software/portal/16-expression-service/src/main/go v0.0.0-00010101000000-000000000000
