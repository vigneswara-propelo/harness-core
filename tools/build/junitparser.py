...
"""
# This code has been directly copied here for now due to lack of a proper
# delivery vehicle. We need to use this in jenkins jobs to parse Harness
# test results and upload for CI.
...
class IntAttr(Attr):
    ...
    def __get__(self, instance, cls):
        ...
        if result is None and (
            ...
            result = super(IntAttr, self).__get__(instance, cls)
        return int(result.replace(",", "")) if result else None
