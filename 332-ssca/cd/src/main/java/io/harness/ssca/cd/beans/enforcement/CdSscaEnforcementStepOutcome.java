...
@TypeAlias("sscaEnforcementStepOutcome")
@JsonTypeName("sscaEnforcementStepOutcome")
public class CdSscaEnforcementStepOutcome implements Outcome, StepDetailsInfo {
