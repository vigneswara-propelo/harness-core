...
public class PipelineYamlSchemaClientModule extends AbstractModule {
    ...
    @Provides
    private PipelineYamlSchemaServiceHttpClientFactory secretNGManagerHttpClientFactory(KryoConverterFactory kryoConverterFactory) {
    ...
    protected void configure() {
        bind(PipelineYamlSchemaServiceClient.class).toProvider(PipelineYamlSchemaServiceHttpClientFactory.class).in(Scopes.SINGLETON);
    }
}
