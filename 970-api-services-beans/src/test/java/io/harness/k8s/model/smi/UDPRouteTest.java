...
public class UDPRouteTest extends CategoryTest {
  @Test
  @Owner(developers = BUHA)
  @Category(UnitTests.class)
  public void testCreatingUDPRouteWithPortMatch() throws IOException {
    UDPRoute udpRoute =
        UDPRoute.builder()
            .apiVersion("specs.smi-spec.io/v1alpha3")
            .metadata(Metadata.builder().name("smi-udp-route").build())
            .spec(
                RouteSpec.builder()
                    .matches(List.of(PortMatch.builder().name("smi-udp-port-rule-1").ports(List.of(7890, 444)).build()))
                    .build())
            .build();

    String path = "/smi/UDPRouteTest.yaml";

    assertEqualYaml(udpRoute, path);
  }

  @Test(expected = IllegalArgumentException.class)
  @Owner(developers = BUHA)
  @Category(UnitTests.class)
  public void testUDPRouteWithHeaderMatch() {
    UDPRoute.builder()
