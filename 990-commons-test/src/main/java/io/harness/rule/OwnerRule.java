...
public class OwnerRule implements TestRule {
  ...
  private static final Map<String, DevInfo> active =
      ImmutableMap.<String, DevInfo>builder()
          ...
          .put(ALEKSANDAR, defaultDevInfo(ALEKSANDAR).slack("U012MKR5FUZ").team(CONTINUOUS_INTEGRATION).build())
          .put(AGORODETKI, defaultDevInfo(AGORODETKI).slack("U013KM8H2NL").team(CONTINUOUS_DEPLOYMENT_CORE).build())
          ...
          .put(ANKUSH, defaultDevInfo(ANKUSH).slack("U016VE8EP7X").team(PLATFORM).build())
          ...
          .put(ARVIND, defaultDevInfo(ARVIND).slack("U01542TQGCU").team(CONTINUOUS_DEPLOYMENT_PLATFORM).build())
          ...
          .put(BRIJESH, defaultDevInfo(BRIJESH).slack("U015LRWS8KV").team(PLATFORM).build())
          .put(DEEPAK, defaultDevInfo(DEEPAK).slack("UK9EKBKQS").team(DEVELOPER_EXPERIENCE).build())
          .put(DHRUV, defaultDevInfo(DHRUV).slack("U012WHYL7G8").team(CONTINUOUS_DEPLOYMENT_CORE).build())
          ...
          .put(GEORGE, defaultDevInfo(GEORGE).slack("U88CA877V").team(DELEGATE).build())
          .put(GUNA, defaultDevInfo(GUNA).slack("UD45NV41W").team(DELEGATE).build())
          ...
          .put(INDER, defaultDevInfo(INDER).slack("U0155TBCW7R").team(CONTINUOUS_DEPLOYMENT_CORE).build())
          ...
          .put(KARAN, defaultDevInfo(KARAN).slack("U015LRX21FD").team(PLATFORM).build())
          .put(MARKO, defaultDevInfo(MARKO).slack("UVDT91N9W").team(DELEGATE).build())
          .put(MATT, defaultDevInfo(MATT).slack("U019QR7TA7M").team(DELEGATE).build())
          ...
          .put(MILOS, defaultDevInfo(MILOS).slack("U014WS8CXEV").team(CONTINUOUS_DEPLOYMENT_CORE).build())
          ...
          .put(NEMANJA, defaultDevInfo(NEMANJA).slack("U016F8DDQSC").team(CONTINUOUS_VERIFICATION).build())
          .put(NIKOLA, defaultDevInfo(NIKOLA).slack("U011CFJ4YDV").team(PLATFORM).build())
          .put(NIKUNJ, defaultDevInfo(NIKUNJ).slack("U019JUP10AF").team(CONTINUOUS_EFFICIENCY).build())
          ...
          .put(PRASHANTSHARMA, defaultDevInfo(PRASHANTSHARMA).slack("U015LRWKR6X").team(PLATFORM).build())
          ...
          .put(SANDESH, defaultDevInfo(SANDESH).slack("U015PLPSD47").team(CONTINUOUS_EFFICIENCY).build())
          .put(SANJA, defaultDevInfo(SANJA).slack("U015Q24465T").team(DELEGATE).build())
          ...
          .put(UTSAV, defaultDevInfo(UTSAV).slack("U015DTMQRV4").team(CONTINUOUS_EFFICIENCY).build())
          ...
          .put(VOJIN, defaultDevInfo(VOJIN).slack("U015TFFL83G").team(PLATFORM).build())
          .put(VISTAAR, defaultDevInfo(VISTAAR).slack("U0138Q1JEHM").team(CONTINUOUS_INTEGRATION).build())
          .put(VUK, defaultDevInfo(VUK).slack("U0115RT3EQL").team(DELEGATE).build())
          ...
          .put(MILAN, defaultDevInfo(MILAN).slack("U012P4GHM7Y").team(CONTINUOUS_DEPLOYMENT_CORE).build())
          .put(ARCHIT, defaultDevInfo(ARCHIT).slack("U012QGPR9N0").team(CONTINUOUS_DEPLOYMENT_CORE).build())
          .put(IVAN, defaultDevInfo(IVAN).slack("U014BFQ9PJS").team(CONTINUOUS_DEPLOYMENT_PLATFORM).build())
          .put(TATHAGAT, defaultDevInfo(TATHAGAT).slack("U015DTMJLA2").team(CONTINUOUS_DEPLOYMENT_PLATFORM).build())
