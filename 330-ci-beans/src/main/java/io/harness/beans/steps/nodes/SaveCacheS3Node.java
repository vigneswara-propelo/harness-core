...
public class SaveCacheS3Node extends CIAbstractStepNode {
  ...
  public String getType() {
    return CIStepInfoType.SAVE_CACHE_S3.getDisplayName();
  }

  @Override
  public StepSpecType getStepSpecType() {
    return saveCacheS3StepInfo;
  }

  enum StepType {
    SaveCacheS3(CIStepInfoType.SAVE_CACHE_S3.getDisplayName());
    @Getter String name;
