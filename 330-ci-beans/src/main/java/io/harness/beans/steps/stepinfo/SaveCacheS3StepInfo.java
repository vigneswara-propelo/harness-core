...
public class SaveCacheS3StepInfo implements PluginCompatibleStep {
  ...
  public static final TypeInfo typeInfo =
      TypeInfo.builder()
          .stepInfoType(CIStepInfoType.SAVE_CACHE_S3)
          .stepType(StepType.newBuilder().setType(CIStepInfoType.SAVE_CACHE_S3.name()).build())
          .build();
  ...
  @ConstructorProperties({"callbackId", "port", "identifier", "name", "retry", "timeout", "connectorRef", "image",
      "resources", "endpoint", "key", "bucket", "sourcePath", "target"})
  public SaveCacheS3StepInfo(String callbackId, Integer port, String identifier, String name, Integer retry,
      ...
      String bucket, List<String> sourcePath, String target) {
