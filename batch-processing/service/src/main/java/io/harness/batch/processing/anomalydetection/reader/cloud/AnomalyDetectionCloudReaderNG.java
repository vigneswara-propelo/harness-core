...
import io.harness.batch.processing.anomalydetection.service.impl.AnomalyDetectionBigQueryServiceImplNG;
...
@Slf4j
public abstract class AnomalyDetectionCloudReaderNG
    implements ItemReader<AnomalyDetectionTimeSeries>, StepExecutionListener {
  @Autowired AnomalyDetectionBigQueryServiceImplNG dataService;
  @Autowired ViewFilterBuilderHelper viewFilterBuilderHelper;
