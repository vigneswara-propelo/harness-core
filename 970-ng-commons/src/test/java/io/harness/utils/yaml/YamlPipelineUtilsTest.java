...
public class YamlPipelineUtilsTest extends CategoryTest {
  ...
  public void testWriteString() throws IOException {
    ...
    assertThat(YamlPipelineUtils.writeString(map).replaceFirst("---\n", "")).isEqualTo(resolvedPipelineYaml);
    assertThat(YamlPipelineUtils.writeString(Map.of("k", "Some Name")).replaceFirst("---\n", ""))
        .isEqualTo("k: Some Name\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new IntNode(42))).replaceFirst("---\n", ""))
        .isEqualTo("k: 42\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new TextNode("42"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"42\"\n");
    map = new LinkedHashMap<String, Object>();
    map.put("k1", "abc");
    map.put("k2", new TextNode("42e4"));
    assertThat(YamlPipelineUtils.writeString(map).replaceFirst("---\n", "")).isEqualTo("k1: abc\nk2: \"42e4\"\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", "true")).replaceFirst("---\n", "")).isEqualTo("k: \"true\"\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", "Some \n Name")).replaceFirst("---\n", ""))
        .isEqualTo("k: \"Some \\n Name\"\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new TextNode("abc"))).replaceFirst("---\n", ""))
        .isEqualTo("k: abc\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new TextNode("+1234"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234\"\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new TextNode("+1234.12"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234.12\"\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new TextNode("+1234."))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234.\"\n");
    assertThat(YamlPipelineUtils.writeString(Map.of("k", new TextNode("+.12"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+.12\"\n");
  }
