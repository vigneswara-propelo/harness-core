...
public class ResourceClaimUtilsTest extends CategoryTest {
  ...
  public void shouldHandleNull() throws Exception {
    assertThat(ResourceClaimUtils.forPod(null, null)).isEqualTo(ResourceClaim.EMPTY);
    assertThat(ResourceClaimUtils.forPodWithScale(null, 0, null, 0)).isEqualTo(ResourceClaim.EMPTY);
  }
  ...
  public void shouldHandlePodWithMultipleContainers() throws Exception {
    assertThat(ResourceClaimUtils.forPod(podSpec(ImmutableList.of(), ImmutableList.of()),
                   podSpec(ImmutableList.of(container("1", "1Gi"), container("100m", "50Mi")), ImmutableList.of())))
        .isEqualTo(new ResourceClaim(1100000000, 1126170624));
  }
  ...
  public void shouldHandlePodWithInitContainerMaxMoreThanContainerSum() throws Exception {
    assertThat(ResourceClaimUtils.forPod(podSpec(ImmutableList.of(), ImmutableList.of()),
        ...
        .isEqualTo(new ResourceClaim(1200000000, 1610612736));
  }
  ...
  public void shouldHandleScaling() throws Exception {
    assertThat(ResourceClaimUtils.forPodWithScale(
        ...
        .isEqualTo(new ResourceClaim(-2200000000L, -2252341248L));
  }
