...
public enum BatchJobType {
  ...
  ECS_EVENT(200, 6, ChronoUnit.HOURS, emptyList(), IN_CLUSTER),
  K8S_EVENT(300, 6, ChronoUnit.HOURS, emptyList(), IN_CLUSTER),
  ...
  INSTANCE_BILLING_HOURLY(600, 1, ChronoUnit.HOURS, Arrays.asList(ECS_UTILIZATION, K8S_UTILIZATION), IN_CLUSTER),
  ACTUAL_IDLE_COST_BILLING_HOURLY(650, 1, ChronoUnit.HOURS, singletonList(INSTANCE_BILLING_HOURLY), IN_CLUSTER),
  UNALLOCATED_BILLING_HOURLY(700, 1, ChronoUnit.HOURS, singletonList(INSTANCE_BILLING_HOURLY), IN_CLUSTER),
  INSTANCE_BILLING(750, 1, ChronoUnit.DAYS, Arrays.asList(ECS_UTILIZATION, K8S_UTILIZATION), IN_CLUSTER),
  K8S_WORKLOAD_RECOMMENDATION(775, 1, ChronoUnit.DAYS, Arrays.asList(K8S_EVENT, INSTANCE_BILLING), IN_CLUSTER),
