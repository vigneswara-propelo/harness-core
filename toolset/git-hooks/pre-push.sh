...
then
    echo '\033[0;31m' checking for PR fix in target branch is disabled - to enable: '\033[0;37m'git config --unset $CHECK_PR_FIX '\033[0m'
else
    echo '\033[0;34m' checking for PR fix target branch  ... to disable: '\033[0;37m'git config --add $CHECK_PR_FIX false '\033[0m'
