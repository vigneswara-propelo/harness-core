...
@JsonTypeName(StepSpecTypeConstants.ASG_BLUE_GREEN_SWAP_SERVICE)
...
public class AsgBlueGreenSwapServiceStepNode extends CdAbstractStepNode {
  ...
  public StepSpecType getStepSpecType() {
    return asgBlueGreenSwapServiceStepInfo;
  }

  enum StepType {
    AsgBlueGreenSwapService(StepSpecTypeConstants.ASG_BLUE_GREEN_SWAP_SERVICE);
    @Getter String name;
