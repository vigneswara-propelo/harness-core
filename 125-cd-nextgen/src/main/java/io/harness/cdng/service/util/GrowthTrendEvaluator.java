...
public class GrowthTrendEvaluator {
   ...
   */
  public List<TimeValuePair<Integer>> getGrowthTrend(
      List<EntityStatusDetails> entities, long startTimeInMs, long endTimeInMs, TimeGroupType timeGroupType) {
    // <startTime, endTime>
  ...
  private Map<Long, Integer> process(
      List<EntityStatusDetails> entities, long startTimeInMs, long endTimeInMs, long intervalTimeInMs) {
