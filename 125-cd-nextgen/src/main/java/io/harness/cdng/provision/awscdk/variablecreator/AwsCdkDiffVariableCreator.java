...
@OwnedBy(CDP)
public class AwsCdkDiffVariableCreator extends GenericStepVariableCreator<AwsCdkDiffStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.AWS_CDK_DIFF);
  }
