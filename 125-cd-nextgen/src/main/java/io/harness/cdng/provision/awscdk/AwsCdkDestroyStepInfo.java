...
import io.harness.cdng.visitor.helpers.cdstepinfo.AwsCdkDestroyStepInfoVisitorHelper;
...
@SimpleVisitorHelper(helperClass = AwsCdkDestroyStepInfoVisitorHelper.class)
@JsonTypeName(StepSpecTypeConstants.AWS_CDK_DESTROY)
@TypeAlias("awsCdkDestroyStepInfo")
@RecasterAlias("io.harness.cdng.provision.awscdk.AwsCdkDestroyStepInfo")
public class AwsCdkDestroyStepInfo extends AwsCdkBaseStepInfo implements CDAbstractStepInfo, Visitable {
  ...
  public AwsCdkDestroyStepInfo(ParameterField<List<TaskSelectorYaml>> delegateSelectors, ParameterField<String> image,
  ...
  public StepType getStepType() {
    return AwsCdkDestroyStep.STEP_TYPE;
  }
  ...
  public SpecParameters getSpecParameters() {
    return AwsCdkDestroyStepParameters.infoBuilder()
