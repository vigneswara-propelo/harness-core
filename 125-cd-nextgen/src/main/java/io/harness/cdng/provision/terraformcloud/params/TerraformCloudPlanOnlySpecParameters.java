...
@RecasterAlias("io.harness.cdng.provision.terraformcloud.params.TerraformCloudPlanOnlySpecParameters")
public class TerraformCloudPlanOnlySpecParameters implements TerraformCloudRunSpecParameters {
  ...
  PlanType planType;
  ParameterField<String> terraformVersion;
  ...
  public void validate() {
    ...
    Validator.notNullCheck("Plan type is null", planType);
  }
