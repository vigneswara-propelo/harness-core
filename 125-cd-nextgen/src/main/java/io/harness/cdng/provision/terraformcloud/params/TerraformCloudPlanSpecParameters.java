...
@RecasterAlias("io.harness.cdng.provision.terraformcloud.params.TerraformCloudPlanSpecParameters")
public class TerraformCloudPlanSpecParameters implements TerraformCloudRunSpecParameters {
  ...
  public TerraformCloudRunType getType() {
    return TerraformCloudRunType.PLAN;
  }
