...
public class TerraformCloudRollbackStepVariableCreator
    extends GenericStepVariableCreator<TerraformCloudRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.TERRAFORM_CLOUD_ROLLBACK);
  }
