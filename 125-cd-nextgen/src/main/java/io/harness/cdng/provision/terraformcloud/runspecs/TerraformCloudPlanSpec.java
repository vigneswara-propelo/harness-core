...
@FieldNameConstants(innerTypeName = "TerraformCloudPlanSpecKeys")
@RecasterAlias("io.harness.cdng.provision.terraformcloud.runspecs.TerraformCloudPlanSpec")
public class TerraformCloudPlanSpec extends TerraformCloudRunExecutionSpec {
