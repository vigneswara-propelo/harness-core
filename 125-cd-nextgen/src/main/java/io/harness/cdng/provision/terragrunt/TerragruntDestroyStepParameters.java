...
@RecasterAlias("io.harness.cdng.provision.terragrunt.TerragruntDestroyStepParameters")
public class TerragruntDestroyStepParameters extends TerragruntDestroyBaseStepInfo implements SpecParameters {
  @NonNull TerragruntStepConfigurationParameters configuration;

  @Builder(builderMethodName = "infoBuilder")
  public TerragruntDestroyStepParameters(ParameterField<String> provisionerIdentifier,
