...
public class TerragruntPlanStep extends TaskExecutableWithRollbackAndRbac<TerragruntPlanTaskResponse> {
  ...
  public void validateResources(Ambiance ambiance, StepElementParameters stepParameters) {
    terragruntStepHelper.checkIfTerragruntFeatureIsEnabled(ambiance, "Terragrunt Plan");
  }

  @Override
  public StepResponse handleTaskResultWithSecurityContext(Ambiance ambiance, StepElementParameters stepParameters,
      ThrowingSupplier<TerragruntPlanTaskResponse> responseDataSupplier) throws Exception {
    // to be added plan handle task logic
  ...
  public TaskRequest obtainTaskAfterRbac(
    ...
    // to be added plan obtain task logic
