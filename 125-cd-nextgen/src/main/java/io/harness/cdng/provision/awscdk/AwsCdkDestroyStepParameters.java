...
@TypeAlias("awsCdkDestroyStepParameters")
@RecasterAlias("io.harness.cdng.provision.awscdk.AwsCdkDestroyStepParameters")
public class AwsCdkDestroyStepParameters extends AwsCdkBaseStepInfo implements SpecParameters, StepParameters {
  ParameterField<List<String>> stackNames;

  @Builder(builderMethodName = "infoBuilder")
  public AwsCdkDestroyStepParameters(ParameterField<List<TaskSelectorYaml>> delegateSelectors,
