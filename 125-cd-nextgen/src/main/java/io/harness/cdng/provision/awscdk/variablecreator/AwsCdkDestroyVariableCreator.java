...
@OwnedBy(CDP)
public class AwsCdkDestroyVariableCreator extends GenericStepVariableCreator<AwsCdkDestroyStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.AWS_CDK_DESTROY);
  }
