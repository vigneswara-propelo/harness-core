...
public class TerraformDestroyStepVariableCreator extends GenericStepVariableCreator<TerraformDestroyStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.TERRAFORM_DESTROY);
  }
