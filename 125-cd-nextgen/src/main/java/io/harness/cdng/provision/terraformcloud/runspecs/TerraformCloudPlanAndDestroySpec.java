...
@FieldNameConstants(innerTypeName = "TerraformCloudPlanAndDestroySpecKeys")
@RecasterAlias("io.harness.cdng.provision.terraformcloud.runspecs.TerraformCloudPlanAndDestroySpec")
public class TerraformCloudPlanAndDestroySpec extends TerraformCloudRunExecutionSpec {
