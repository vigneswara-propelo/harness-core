...
public class AwsSamBuildStepVariableCreator extends GenericStepVariableCreator<AwsSamBuildStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.AWS_SAM_BUILD);
  }
