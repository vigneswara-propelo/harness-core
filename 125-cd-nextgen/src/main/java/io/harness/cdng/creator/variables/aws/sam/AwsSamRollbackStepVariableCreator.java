...
public class AwsSamRollbackStepVariableCreator extends GenericStepVariableCreator<AwsSamRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.AWS_SAM_ROLLBACK);
  }
