...
public class GoogleFunctionsGenOneRollbackStepVariableCreator
    extends GenericStepVariableCreator<GoogleFunctionsGenOneRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.GOOGLE_CLOUD_FUNCTIONS_GEN_ONE_ROLLBACK);
  }
