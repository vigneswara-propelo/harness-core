...
@UtilityClass
public class BambooBuildStepUtils {
  public Map<String, ParameterField<String>> processBambooFieldsList(List<BambooParameterField> fields) {
    if (fields == null) {
      return null;
    }
  ...
  public Map<String, String> processBambooFieldsInParameters(Map<String, ParameterField<String>> fields) {
