...
public interface JenkinsBuildStepHelperService {
  ...
  TaskChainResponse queueJenkinsBuildTask(
      JenkinsArtifactDelegateRequestBuilder paramsBuilder, Ambiance ambiance, StepBaseParameters stepElementParameters);

  TaskChainResponse pollJenkinsJob(JenkinsArtifactDelegateRequestBuilder paramsBuilder, Ambiance ambiance,
      StepBaseParameters stepElementParameters, ResponseData artifactTaskExecutionResponse);
