...
public class ServerlessAwsLambdaPackageV2StepInfoVisitorHelper implements ConfigValidator {
  @Override
  public Object createDummyVisitableElement(Object originalElement) {
    return ServerlessAwsLambdaPackageV2StepInfo.infoBuilder().build();
  }
