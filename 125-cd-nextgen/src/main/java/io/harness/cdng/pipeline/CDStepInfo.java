...
@ApiModel(subTypes = {MergePRStepInfo.class, RevertPRStepInfo.class, UpdateGitOpsAppStepInfo.class, SyncStepInfo.class,
              ...
              DownloadAwsS3StepInfo.class, DownloadHarnessStoreStepInfo.class, K8sTrafficRoutingStepInfo.class})
