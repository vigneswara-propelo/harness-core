...
@Slf4j
public class AwsCdkDeployPluginInfoProviderTest extends CategoryTest {
  @Rule public MockitoRule mockitoRule = MockitoJUnit.rule();
  @InjectMocks @Spy private AwsCdkDeployPluginInfoProvider awsCdkDeployPluginInfoProvider;
  ...
  public void testGetPluginInfo() {
    ...
    doReturn(cdAbstractStepNode).when(awsCdkDeployPluginInfoProvider).getCdAbstractStepNode(any(), any());
    AwsCdkDeployStepInfo awsCdkDeployStepInfo =
        AwsCdkDeployStepInfo.infoBuilder()
            ...
            .build();
    doReturn(awsCdkDeployStepInfo).when(cdAbstractStepNode).getStepSpecType();

    PluginCreationResponseWrapper pluginCreationResponseWrapper =
        awsCdkDeployPluginInfoProvider.getPluginInfo(pluginCreationRequest, new HashSet<>(), ambiance);
