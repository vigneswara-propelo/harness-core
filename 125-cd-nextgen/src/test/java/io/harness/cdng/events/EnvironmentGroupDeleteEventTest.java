...
public class EnvironmentGroupDeleteEventTest extends CategoryTest {
  private String ACC_ID = "accId";
  private String ORG_ID = "orgId";
  private String PRO_ID = "proId";
  private String ENV_GROUP_ID = "envGroupId";

  private EnvironmentGroupDeleteEvent deleteEvent;
  @Before
  public void before() {
    deleteEvent = new EnvironmentGroupDeleteEvent(ACC_ID, ORG_ID, PRO_ID,
  ...
  public void getEventType() {
    assertThat(deleteEvent.getEventType()).isEqualTo(OutboxEventConstants.ENVIRONMENT_GROUP_DELETED);
  }
