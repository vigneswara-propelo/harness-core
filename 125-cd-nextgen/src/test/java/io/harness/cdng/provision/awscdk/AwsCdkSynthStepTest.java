...
public class AwsCdkSynthStepTest extends CategoryTest {
  ...
  public void testGetSerialisedStep() {
    ...
    StepElementParameters stepElementParameters =
        StepElementParameters.builder()
            ...
            .spec(AwsCdkSynthStepParameters.infoBuilder()
    ...
    UnitStep result =
        awsCdkSynthStep.getSerialisedStep(ambiance, stepElementParameters, "accountId", "logKey", 6000, "taskId");
  ...
  public void testGetTimeout() {
    ...
    assertThat(awsCdkSynthStep.getTimeout(ambiance, stepElementParameters)).isEqualTo(1200000L);
  }
