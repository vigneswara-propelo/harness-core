...
public class AwsCdkDiffStepTest extends CategoryTest {
  ...
  @InjectMocks AwsCdkDiffStep awsCdkDiffStep;
  ...
  public void testGetSerialisedStep() {
    ...
    UnitStep result =
        awsCdkDiffStep.getSerialisedStep(ambiance, stepElementParameters, "accountId", "logKey", 6000, "taskId");
