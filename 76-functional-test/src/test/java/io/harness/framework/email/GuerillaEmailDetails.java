...
public class GuerillaEmailDetails {
  @JsonProperty("list") private java.util.List<EmailMetaData> list = null;
  ...
  @JsonProperty("list")
  public java.util.List<EmailMetaData> getList() {
    return list;
  }

  @JsonProperty("list")
  public void setList(java.util.List<EmailMetaData> list) {
    this.list = list;
  }
