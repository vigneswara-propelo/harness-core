...
package io.harness.idp.eventlisteners.eventhandler;
...
import io.harness.idp.eventlisteners.factory.EventMessageHandlerFactory;
  ...
  public boolean handleMessage(Message message) {
    ...
    try (AutoLogContext ignore = new NgEventLogContext(messageId, OVERRIDE_ERROR)) {
      ...
      if (eventMessageHandler != null) {
        eventMessageHandler.handelMessage(message, entityChangeDTO, action);
