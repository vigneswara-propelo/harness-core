...
chmod +x idp-service/build/build_jar.sh
chmod +x idp-service/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD idp-service/build.properties
idp-service/build/build_jar.sh
idp-service/build/build_dist.sh || true
