...
@Getter
@NoArgsConstructor
public class ScorecardUpdateEvent implements Event {
  public static final String SCORECARD_UPDATED = "ScorecardUpdated";

  private ScorecardDetailsResponse newScorecardDetailsResponse;
  private ScorecardDetailsResponse oldScorecardDetailsResponse;
  private String accountIdentifier;

  public ScorecardUpdateEvent(String accountIdentifier, ScorecardDetailsResponse newScorecardDetailsResponse,
      ScorecardDetailsResponse oldScorecardDetailsResponse) {
    this.newScorecardDetailsResponse = newScorecardDetailsResponse;
