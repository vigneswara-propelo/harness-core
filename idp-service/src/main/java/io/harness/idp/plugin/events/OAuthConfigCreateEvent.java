...
@Getter
@NoArgsConstructor
public class OAuthConfigCreateEvent implements Event {
  public static final String OAUTH_CONFIG_CREATED = "OAuthConfigCreated";

  private List<BackstageEnvVariable> newBackstageEnvVariables;
  private String accountIdentifier;
  private String authId;

  public OAuthConfigCreateEvent(String accountIdentifier, String authId, List<BackstageEnvVariable> envVariables) {
    this.newBackstageEnvVariables = envVariables;
