...
@Getter
@NoArgsConstructor
public class CatalogConnectorCreateEvent implements Event {
  public static final String CATALOG_CONNECTOR_CREATED = "CatalogConnectorCreated";

  private CatalogConnectorEntity newCatalogConnectorEntity;
  private String accountIdentifier;

  public CatalogConnectorCreateEvent(String accountIdentifier, CatalogConnectorEntity newCatalogConnectorEntity) {
  ...
  public String getEventType() {
    return CATALOG_CONNECTOR_CREATED;
  }
}
