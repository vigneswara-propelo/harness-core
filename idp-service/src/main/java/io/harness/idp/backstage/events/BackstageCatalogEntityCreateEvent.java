...
@Getter
@NoArgsConstructor
public class BackstageCatalogEntityCreateEvent implements Event {
  public static final String BACKSTAGE_CATALOG_ENTITY_CREATED = "BackstageCatalogEntityCreated";
  private String accountIdentifier;
  private String newEntityUid;
  private String newYaml;

  public BackstageCatalogEntityCreateEvent(String accountIdentifier, String newEntityUid, String newYaml) {
  ...
  public String getEventType() {
    return BACKSTAGE_CATALOG_ENTITY_CREATED;
  }
}
