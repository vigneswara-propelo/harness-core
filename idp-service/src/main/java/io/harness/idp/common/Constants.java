...
public class Constants {
  ...
  public static final List<String> pluginIds = List.of("circleci", "firehydrant", "gitlab", "harness-ci-cd",
      "harness-feature-flags", "jenkins", "jira", "lighthouse", "pager-duty", "snyk-security", "todo");
