...
public class IdpCookieCutterStepPlanCreator extends CIPMSStepPlanCreatorV2<IdpCookieCutterStepNode> {
  ...
  @Override
  public Class<IdpCookieCutterStepNode> getFieldClass() {
    return IdpCookieCutterStepNode.class;
  }

  @Override
  public PlanCreationResponse createPlanForField(PlanCreationContext ctx, IdpCookieCutterStepNode stepElement) {
