...
@TypeAlias("IdpCreateCatalogStepInfo")
@OwnedBy(HarnessTeam.IDP)
@Builder
@AllArgsConstructor
@RecasterAlias("io.harness.idp.pipeline.steps.beans.stepinfo.IdpCreateCatalogStepInfo")
public class IdpCreateCatalogStepInfo implements PluginCompatibleStep {
  ...
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> fileName;
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> filePath;
  @ApiModelProperty(dataType = STRING_CLASSPATH) ParameterField<String> fileContent;

  ContainerResource resources;

  @Override
  public TypeInfo getNonYamlInfo() {
    return TypeInfo.builder().stepInfoType(CIStepInfoType.CREATE_CATALOG).build();
  }

  @Override
  public StepType getStepType() {
    return Constants.CREATE_CATALOG_STEP_TYPE;
  }
