...
public class HeartbeatMetricContext extends AutoMetricContext {
  public HeartbeatMetricContext(String accountId, String accountName, String companyName, String orgId,
      String projectId, String delegateName, String delegateId, String delegateVersion, String delegateConnectionStatus,
      String delegateEventType, boolean isNg, boolean isImmutable) {
