...
@Getter
@Builder
public class NGLdapTestAuthenticationTaskParameters implements TaskParameters, ExecutionCapabilityDemander {
  LdapSettings ldapSettings;
  EncryptedDataDetail settingsEncryptedDataDetail;
