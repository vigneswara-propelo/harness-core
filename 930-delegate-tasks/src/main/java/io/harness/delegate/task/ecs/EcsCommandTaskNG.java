...
public class EcsCommandTaskNG extends AbstractDelegateRunnableTask {
  @Inject private EcsDelegateTaskHelper ecsDelegateTaskHelper;

  public EcsCommandTaskNG(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
