...
@Slf4j
public class NGLdapValidateUserQuerySettingTask extends AbstractDelegateRunnableTask {
  @Inject private LdapDelegateService ldapDelegateService;

  public NGLdapValidateUserQuerySettingTask(DelegateTaskPackage delegateTaskPackage,
  ...
  public DelegateResponseData run(TaskParameters parameters) {
    ...
    LdapTestResponse ldapTestResponse = ldapDelegateService.validateLdapUserSettings(
