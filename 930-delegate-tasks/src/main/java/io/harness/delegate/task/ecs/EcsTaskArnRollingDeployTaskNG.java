...
public class EcsTaskArnRollingDeployTaskNG extends AbstractDelegateRunnableTask {
  @Inject private EcsDelegateTaskHelper ecsDelegateTaskHelper;
  public EcsTaskArnRollingDeployTaskNG(DelegateTaskPackage delegateTaskPackage,
