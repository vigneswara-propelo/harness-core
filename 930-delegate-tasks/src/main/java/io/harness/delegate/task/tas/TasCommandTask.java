...
public class TasCommandTask extends AbstractDelegateRunnableTask {
  @Inject private CfDelegateTaskHelper cfDelegateTaskHelper;
  @Inject TasRunPluginCommandTaskHandler tasRunPluginCommandTaskHandler;

  public TasCommandTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
  ...
  public CfCommandResponseNG run(TaskParameters parameters) {
    ...
    return cfDelegateTaskHelper.getCfCommandResponse(
        tasRunPluginCommandTaskHandler, cfCommandRequestNG, getLogStreamingTaskClient());
  }
