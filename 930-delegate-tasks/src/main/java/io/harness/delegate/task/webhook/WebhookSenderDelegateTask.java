...
package io.harness.delegate.task.webhook;
...
public class WebhookSenderDelegateTask extends AbstractDelegateRunnableTask {
  @Inject private WebhookSenderImpl webhookSender;

  public WebhookSenderDelegateTask(DelegateTaskPackage delegateTaskPackage,
