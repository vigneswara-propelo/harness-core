...
@Slf4j
public class NGLdapValidateGroupQuerySettingTask extends AbstractDelegateRunnableTask {
  @Inject private LdapDelegateService ldapDelegateService;

  public NGLdapValidateGroupQuerySettingTask(DelegateTaskPackage delegateTaskPackage,
  ...
  public DelegateResponseData run(TaskParameters parameters) {
    ...
    LdapTestResponse ldapTestResponse = ldapDelegateService.validateLdapGroupSettings(
