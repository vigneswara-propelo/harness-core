...
public class GoogleFunctionDeployWithoutTrafficTask extends AbstractDelegateRunnableTask {
  @Inject private GoogleFunctionDelegateTaskHelper googleFunctionDelegateTaskHelper;
  public GoogleFunctionDeployWithoutTrafficTask(DelegateTaskPackage delegateTaskPackage,
