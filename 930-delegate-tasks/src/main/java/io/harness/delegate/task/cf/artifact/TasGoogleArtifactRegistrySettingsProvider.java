...
public class TasGoogleArtifactRegistrySettingsProvider extends AbstractTasRegistrySettingsProvider {
  private static final String GAR_USERNAME = "_json_key";
  ...
  public TasArtifactCreds getContainerSettings(
    ...
    validateSettings(artifactConfig, registryUrl, GAR_USERNAME, decryptedSecret);
    return populateDockerSettings(registryUrl, GAR_USERNAME, decryptedSecret);
  }
}
