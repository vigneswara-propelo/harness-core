...
public class TasAppResizeTask extends AbstractDelegateRunnableTask {
  @Inject private CfDelegateTaskHelper cfDelegateTaskHelper;
  @Inject CfDeployCommandTaskHandlerNG cfDeployCommandTaskHandlerNG;

  public TasAppResizeTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
  ...
  public CfCommandResponseNG run(TaskParameters parameters) {
    ...
    return cfDelegateTaskHelper.getCfCommandResponse(
        cfDeployCommandTaskHandlerNG, cfCommandRequestNG, getLogStreamingTaskClient());
  }
