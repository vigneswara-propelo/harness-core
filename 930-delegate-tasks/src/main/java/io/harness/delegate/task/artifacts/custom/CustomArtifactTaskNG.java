...
@Slf4j
public class CustomArtifactTaskNG extends AbstractDelegateRunnableTask {
  @Inject CustomArtifactTaskHelper customArtifactTaskHelper;

  public CustomArtifactTaskNG(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
