  ...
  public void executeTaskInternalTestWhenPackageArtifact() throws Exception {
    ...
    CfRequestConfig cfRequestConfig =
        CfRequestConfig.builder()
            ...
            .cfCliPath(pcfCommandTaskHelper.getCfCliPathOnDelegate(true, cfRollingRollbackRequestNG.getCfCliVersion()))
    ...
    doReturn(Arrays.asList(applicationSummary))
        ...
        .getPreviousReleasesForRolling(cfRequestConfig, cfRollingRollbackRequestNG.getApplicationName());
