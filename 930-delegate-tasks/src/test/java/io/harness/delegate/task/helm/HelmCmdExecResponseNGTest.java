...
@Slf4j
public class HelmCmdExecResponseNGTest extends CategoryTest {
  @Inject HelmCmdExecResponseNG helmCmdExecResponseNG;

  @Before
  public void setup() throws Exception {
    helmCmdExecResponseNG =
        HelmCmdExecResponseNG.builder().helmCommandResponse(HelmInstallCmdResponseNG.builder().build()).build();
  }
  @Test
  @Owner(developers = NAMAN_TALAYCHA)
  @Category(UnitTests.class)
  public void getStepExecutionInstanceInfoNullCase() {
    StepExecutionInstanceInfo stepExecutionInstanceInfo = helmCmdExecResponseNG.getStepExecutionInstanceInfo();
