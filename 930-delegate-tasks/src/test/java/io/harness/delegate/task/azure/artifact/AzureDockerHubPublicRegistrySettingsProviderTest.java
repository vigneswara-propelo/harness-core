...
@OwnedBy(CDP)
public class AzureDockerHubPublicRegistrySettingsProviderTest extends CategoryTest {
  @Rule public MockitoRule mockitoRule = MockitoJUnit.rule();

  @InjectMocks private AzureDockerHubPublicRegistrySettingsProvider settingsProvider;
  ...
  public void testGetContainerSettings() {
    ...
    assertThat(dockerSettings.values().stream().map(AzureAppServiceApplicationSetting::getValue))
        .containsExactlyInAnyOrder(dockerRegistryUrl);
  }
}